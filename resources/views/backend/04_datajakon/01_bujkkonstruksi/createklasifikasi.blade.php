        ...
        <div class="card card-primary card-outline mb-6">
            ...
            <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px; margin-top: 10px;">
                ...
                <input
                    ...
                    style="padding: 10px 20px; border: 1px solid #ccc; border-radius: 15px; font-size: 16px; background-color: #f9f9f9; font-family: 'Poppins', sans-serif;"
                >
                ...
                <a href="/bebujkkonstruksi" style="text-decoration: none;">
                    <button
                        ...
                        style="background-color: #374151; color: white; border: none; padding: 10px 20px; border-radius: 15px; font-size: 16px; cursor: pointer; display: flex; align-items: center; transition: background-color 0.3s, color 0.3s; font-family: 'Poppins', sans-serif;"
                    >
                        <!-- Ikon Kembali -->
