                    ...
                    @include('backend.00_administrator.00_baganterpisah.10_judulhalaman')
                     ...
                     <div style="display: flex; justify-content: flex-end; margin-bottom: 5px;">
                        ...
                        <script>
                            ...
                            fetch(`/hakaksespekerjaberkas?search=${input}`)
     ...
     <tr>
        <th style="width: 75px; text-align:center; vertical-align: middle;">
          ...
          <th style="width: 200px; text-align:center; vertical-align: middle;">
            <i class="bi bi-people-fill"></i> Berkas Anda
          </th>
    ...
    <tr>
        <td colspan="100%"> {{-- Memenuhi semua kolom --}}
            ...
            ">
                ...
                Saudara Belum Mengikuti Kegiatan Apapun !! Silahkan -> <a href="/hakaksespekerjaskkdaftar"><span class="button-hijau">Daftar</span></a>
            </div>
        </td>
    </tr>
@endforelse
