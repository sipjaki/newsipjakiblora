...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-file mr-2"></i>Rencana Strategis Program Dan Jasa Konstruksi </div></label>
        </a>
        <a style="background: white;">
            <div class="badgehidden" style="color: white"><i class="fas fa-file mr-2"></i>Sipjaki Kab Bandung Barat </div></label>
        </a>
