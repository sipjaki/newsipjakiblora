...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('updatestore.tupoksi', $tupoksi->judul) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="judul" name="judul" value="{{ old('judul', $tupoksi->judul) }}" required>
                </div>
    
                <div class="form-group">
                    <label for="peraturan" style="text-align:left;"><i class="fas fa-file me-2" ></i> File Peraturan Undang-Undang</label>
                    <input type="file" id="peraturan" name="peraturan" value="{{ old('peraturan', $tupoksi->peraturan) }}">
                </div>
