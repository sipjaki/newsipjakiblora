                    ...
                    @include('backend.00_administrator.00_baganterpisah.12_judulupdate')
                     ...
                     <div style="display: flex; justify-content: flex-end; margin-bottom: 5px;">
                        <div style="position: relative; display: inline-block; margin-right:10px;">
                            <input type="search" id="searchInput" placeholder="Cari Artikel  ...." onkeyup="searchTable()" style="border: 1px solid #ccc; padding: 10px 20px; font-size: 14px; border-radius: 10px; width: 300px;">
...
<table class="zebra-table table-striped">
 <thead>
    ...
    <th style="width: 500px; text-align:center;">
        <i class="bi bi-file-earmark-text"></i> Artikel Jakon
    </th>
 ...
 <tbody id="tableBody">
     ...
     <tr class="align-middle">
         ...
         <td style="text-align: center;">{{$item->user->name ?? 'Data Tidak Di Temukan !'}}</td>
         <td style="text-align: left; max-width: 300px; white-space: normal; word-wrap: break-word; word-break: break-word;">
            {{$item->judul ?? 'Data Tidak Ditemukan'}}
        </td>

         <td style="text-align: center;">{{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('l, d F Y') }}</td>

         <td style="text-align: center; vertical-align: middle;">
             <a href="/beartikeljakon/show/{{$item->id}}" class="button-baru" title="Show">
                 <i class="bi bi-eye"></i>
             </a>
             <a href="/beartikeljakon/update/{{$item->id}}" class="button-berkas" title="Update">
