                        ...
                        <form action="{{ route('create.beartikeljakoncreatenew') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-modern mb-3">
                                            <label class="form-label-modern" for="keterangan">
                                                <i class="bi bi-file-earmark-text" style="margin-right: 8px; color: navy;"></i> Keterangan Artikel
                                            </label>
                            ...
                            <div style="display: flex; justify-content: flex-end; margin-bottom:20px;">
                                <div class="flex justify-end">
                                    <button type="button" onclick="openModal()" class="button-baru" style="display: flex; align-items: center; gap: 8px; padding: 8px 12px;">
