                        ...
                        <form action="{{ route('create.beberitajakoncreatenew') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="judulberita" name="judulberita"
                                            class="form-control @error('judulberita') is-invalid @enderror"
                                            rows="6">{{ old('judulberita') }}</textarea>
                                        ...
                                        <div class="form-modern mb-3">
                                            <label class="form-label-modern" for="keterangan">
                                                <i class="bi bi-file-earmark-text" style="margin-right: 8px; color: navy;"></i> Keterangan Berita
                                            </label>
                            ...
                            <div style="display: flex; justify-content: flex-end; margin-bottom:20px;">
                                <div class="flex justify-end">
                                        <button type="button" onclick="openModal()" class="button-baru" style="display: flex; align-items: center; gap: 8px;">
                                            <!-- Ikon plus Bootstrap Icons -->
