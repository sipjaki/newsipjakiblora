    ...
    <i class="bi bi-search"
       style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); font-size: 16px; color: #888;"></i>
                        ...
                        <script>
                            ...
                            fetch(`/settingsstatuspekerjaan?search=${input}`)
...
<button class="button-berkas" onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_statuspekerjaan')">

    <i class="bi bi-download" style="margin-right: 5px;"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/settingsstatuspekerjaan/create">
...
<table id="tabelBujkkonstruksi" class="zebra-table table-striped" >
 <thead>
     <tr>
        ...
        <th style="width: 800px; text-align:center;"><i class="bi bi-people-fill"></i> Status Pekerjaan</th>
 ...
 <tbody id="tableBody">
     ...
     <tr class="align-middle">
         ...
         <td style="text-align: left;">{{ $item->paketstatuspekerjaan }}</td>
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/settingsstatuspekerjaan/delete/" + encodeURIComponent(id);
