...
<br>
    ...
    <input type="search" id="searchInput"
           placeholder="Cari Tahun Pelaksanaan ...."
           onkeyup="searchTable()"
    ...
    <i class="bi bi-search"
       style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); font-size: 16px; color: #888;"></i>
                        ...
                        <script>
                            ...
                            fetch(`/settingstahunpilihan?search=${input}`)
...
<button class="button-berkas" onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_tahunpelaksanaan')">

    <i class="bi bi-download" style="margin-right: 5px;"></i> Download Excel
</button>

<!-- Tombol Create -->
<a href="/settingstahunpilihan/create">
...
<table id="tabelBujkkonstruksi" class="zebra-table table-striped" >
 <thead>
     <tr>
        ...
        <th style="width: 800px; text-align:center;"><i class="bi bi-people-fill"></i> Tahun Pelaksanaan</th>
 ...
 <tbody id="tableBody">
     ...
     <tr class="align-middle">
         ...
         <td style="text-align: left;">{{ $item->tahunpilihan }}</td>
...
@keyframes fadeIn {
    ...
    to { opacity: 1; transform: translateY(0); }
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/settingstahunpilihan/delete/" + encodeURIComponent(id);
