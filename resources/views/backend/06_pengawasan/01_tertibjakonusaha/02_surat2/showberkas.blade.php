...
<tr>
    @php
        $kesesuaian = $datasurat2->kesesuaian ?? 'Surat Belum Di Buat';
...
@php
        $kesesuaian = $datasurat2->kesesuaianklasifikasi ?? 'Surat Belum Di Buat';
        $tertibStatus = $kesesuaian === 'Sesuai' ? 'TERTIB' : 'BELUM TERTIB';
        $color = $kesesuaian === 'Sesuai' ? 'blue' : 'red';
        $icon = $kesesuaian === 'Sesuai' ? 'bi-check-circle' : 'bi-x-circle';
    @endphp
...
@php
        $kesesuaian = $datasurat2->kesesuaianlayananusaha ?? 'Surat Belum Di Buat';
        $tertibStatus = $kesesuaian === 'Sesuai' ? 'TERTIB' : 'BELUM TERTIB';
        $color = $kesesuaian === 'Sesuai' ? 'blue' : 'red';
        $icon = $kesesuaian === 'Sesuai' ? 'bi-check-circle' : 'bi-x-circle';
    @endphp
                                                ...
                                                <tr>
                                                  ...
                                                  <td style="border: 1px solid #000; width: 400px;">
                                                    <textarea
                                                        ...
                                                        rows="6"
                                                        style="width: 100%; resize: vertical;">{{ old('namapaketpekerjaan', $datasurat2->namapaketpekerjaan ?? 'Data Masih Kosong') }}</textarea>
                                                   ...
                                                   <td style="border: 1px solid #000; font-size: 16px; text-align:center;">
                                                        {{ $datasurat2->jenisusaha ?? '-' }}
                                                    </td>

                                                    <td style="border: 1px solid #000; font-size: 16px; text-align:center;">
                                                        {{ $datasurat2->kesesuaian ?? '-' }}
                                                    </td>

                                                    <td style="border: 1px solid #000; font-size: 16px; text-align:center;">
                                                        {{ $datasurat2->sifatusaha ?? '-' }}
                                                    </td>

                                                    <td style="border: 1px solid #000; font-size: 16px; text-align:center;">
                                                        {{ $datasurat2->kesesuaiansbu ?? '-' }}
                                                    </td>
