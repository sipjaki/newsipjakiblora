                                    ...
                                    <tr>
                                     <th style="width: 25px; text-align: center;">
                                                ...
                                                <th style="width: 200px; text-align: center;">
                                                    <i class="bi bi-building-fill"></i> Pemeliharaan Konstruksi
                                                </th>

                                                <th style="width: 200px; text-align: center;">
                                                    <i class="bi bi-building-fill"></i> Pemeliharaan Struktur
                                                </th>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td style="text-align: center;">
                                         ...
                                         function setDeleteUrl(button) {
                                             ...
                                             var deleteUrl = "{{ route('betertibjakonmanfaat3deleteberkas', ':id') }}";
...
<!-- Tombol Submit -->
   ...
   <div class="modal fade" id="modalKtp{{ $datasurat_id }}" tabindex="-1" aria-labelledby="modalKtpLabel{{ $datasurat_id }}" aria-hidden="true">
    ...
    <!-- Container untuk gambar tanda tangan -->
    <div style="position: relative; width: 200px; height: 100px;">
        <!-- TTD Pa Arif di bawah -->
        <img src="/assets/icon/ttdpaarif.png" alt="TTD Pa Arif"
        ...
        <img src="/assets/icon/ttdkabblora.png" alt="TTD Kab Blora"
             style="position: absolute; top: 0; left: 0; width: 125px; height: auto; z-index: 2; opacity: 0.9;">
    </div>
...
<script>
    function downloadModalPDF(id) {
        ...
        clone.style.transform = 'translateY(-25px)'; // Dorong ke atas ekstrim
