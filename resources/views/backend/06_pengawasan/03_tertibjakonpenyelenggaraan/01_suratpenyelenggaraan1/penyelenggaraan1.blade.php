...
<section style="background: linear-gradient(to bottom, #a8f0c6, #ffffff); width: 100%; min-height: 100vh;">
    ...
    @if ($datasurat->isEmpty())
        <a href="{{ route('betertibjakonpenyelenggaraan1create', ['id' => $id]) }}">
                                    ...
                                    <tr>
                                     <th style="width: 25px; text-align: center;">
                                                ...
                                                <th style="width: 200px; text-align: center;">
                                                    <i class="bi bi-building-fill"></i> Pengawasan Pemilihan Penyedia Jasa
                                                </th>
        ...
        {{ $tertibStatus }}
                                        ...
                                        <td style="text-align: center;">
                                         ...
                                         function setDeleteUrl(button) {
                                             ...
                                             var deleteUrl = "{{ route('betertibjakonpenyelenggaraan1delete', ':id') }}";
    ...
    <tr>
        <td colspan="100%"> {{-- Memenuhi semua kolom --}}
            ...
            ">
                ...
                Berkas Dukung Pengawasan Pemilihan Penyedia Jasa Tidak Ditemukan !!
            </div>
        </td>
    </tr>
@endforelse
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            {{-- <input type="hidden"  name="tertibjakonpemanfaatan_id" value="{{ $datatertibjasakonstruksi_id }}"> --}}
                                ...
                                <div class="modal-content" style="font-size: 0.875rem;">
                                    ...
                                    <br>
                                    <div class="modal-body">
                                        <h5 style="font-size: 15px;">Surat Dukung Tertib Jakon Penyelenggaraan : Pengawasan Tertib Penyelenggaraan Konstruksi Secara Rutin <br> Penyelenggaraan Konstruksi dengan Sumber Dana dari APBD <br> <strong>Pengawasan Terhadap Pemilihan Penyedia Jasa </strong> </h5>
                                            <br>
...
<tr>
    ...
    <thead>
        <tr>
            ...
            <th style="border: 1px solid #000; text-align: center; background-color: #f8f9fa; width:200px;">Kesimpulan Pemeriksaan</th>
            <th style="border: 1px solid #000; text-align: center; background-color: #f8f9fa; width:300px;">Catatan Pemeriksaan</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="border: 1px solid #000; text-align: center;">1</td>
            <td style="border: 1px solid #000; padding: 5px;">Pengawasan terhadap proses pemilihan Penyedia Jasa</td>
            <td style="border: 1px solid #000; padding: 5px;">Terlaksananya pemilihan Penyedia Jasa Konstruksi dilakukan sesuai dengan ketentuan peraturan perundang-undangan.</td>
            <td style="border: 1px solid #000; padding: 5px;">Surat pernyataan Kuasa Pengguna Anggaran atau pejabat pembuat komitmen bahwa proses pemilihan Penyedia Jasa konstruksi sesuai dengan ketentuan peraturan perundang-undangan.</td>
            <td style="border: 1px solid #000; padding: 5px;">
                <ul style="margin:0; padding-left:15px;">
                    <li>Memeriksa ketersediaan surat pernyataan</li>
                    <li>Memeriksa isi surat pernyataan</li>
                </ul>
            </td>
<td style="border: 1px solid #000; text-align: center;">
    @php
        $statusClass = ($firstsurat->cadangan1 ?? '') === 'Sesuai' ? 'button-hijau' : 'button-merah';
        $statusText = $firstsurat->cadangan1 ?? '-';
    @endphp
    <span class="{{ $statusClass }}" style="padding: 4px 8px; border-radius: 4px; display: inline-block;">
        {{ $statusText }}
    </span>
</td>

<td style="border: 1px solid #000; padding:10px;">
    {{ $firstsurat->cadangan2 ?? '-' }}
</td>
                                                                        ...
                                                                        <table class="table table-sm">
                                                                            <thead class="table-secondary">
                                                                                <tr>
                                                                                    ...
                                                                                    <th style="width: 60px; text-align: center; font-size: 15px; text-align:center;">Nama Pemeriksa</th>
                                                                                    <th style="width: 100px; text-align: center; font-size: 15px; text-align:center;">Tanda Tangan</th>
                                                                                </tr>
                                                                            </thead>
...
<!-- Tombol Submit -->
   ...
   <div class="modal fade" id="modalKtp{{ $datasurat_id }}" tabindex="-1" aria-labelledby="modalKtpLabel{{ $datasurat_id }}" aria-hidden="true">
                                        ...
                                        <div class="modal-content" style="font-size: 0.875rem; margin-top:-10px;" >
                                            ...
                                            <div class="modal-body">
                                                <h5 style="font-size: 1rem;">Surat Dukung Tertib Jakon Penyelenggaraan : <br> Pengawasan Tertib Penyelenggaraan Konstruksi Secara Rutin <br> Penyelenggaraan Konstruksi dengan Sumber Dana dari APBD <br> <strong>Pengawasan Terhadap Pemilihan Penyedia Jasa </strong> </h5>
                                                {{-- <table class="table table-bordered table-sm" style="font-size: 14px;"> --}}
                                                   {{-- <tr>
...
<script>
    function downloadModalPDF(id) {
        ...
        // Format nama file
        const fileName = `Tertibjakonpenyelenggaraan_surat1_${id}.pdf`;
