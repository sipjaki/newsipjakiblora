...
<section style="background: linear-gradient(to bottom, #a8f0c6, #ffffff); width: 100%; min-height: 100vh;">
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                        <form action="{{ route('betertibjakonpenyelenggaraan1createnew') }}" method="POST" enctype="multipart/form-data">
                            @csrf
...
<table style="width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 20px;">
    ...
    <select class="form-control @error('cadangan1') is-invalid @enderror" name="cadangan1">
        <option value="">-- Pilih --</option>
        <option value="Sesuai" {{ old('cadangan1') == 'Sesuai' ? 'selected' : '' }}>Tersedia</option>
        <option value="Tidak Sesuai" {{ old('cadangan1') == 'Tidak Sesuai' ? 'selected' : '' }}>Tidak Tersedia</option>
    </select>
    @error('cadangan1')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
...
<td style="border: 1px solid #000;">
    <textarea
        ...
        name="cadangan2"
        rows="3"
        placeholder="Masukkan Catatan Pemeriksaan...">{{ old('cadangan2') }}</textarea>
    @error('cadangan2')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</td>
