    ...
    <div class="tim-pemeriksa" style="margin-top:10px; font-size: 0.75rem;">
        ...
        <table class="table table-bordered table-sm" style="margin-top:-5px; font-size: 0.75rem;">
            ...
            <tbody>
                ...
                <td style="text-align:center;">
    <div>
        @if(optional($firstsurat->tandatangan1)->tandatangan && file_exists(storage_path('app/public/' . (optional($firstsurat->tandatangan1)->tandatangan ?? ''))))
            <img src="{{ asset('storage/' . (optional($firstsurat->tandatangan1)->tandatangan ?? '')) }}"
                 alt="Tanda Tangan"
                 style="max-height:40px;">
        @elseif(optional($firstsurat->tandatangan1)->tandatangan ?? false)
...
<td style="text-align:center;">
    <div>
        @if(optional($firstsurat->tandatangan2)->tandatangan && file_exists(storage_path('app/public/' . (optional($firstsurat->tandatangan2)->tandatangan ?? ''))))
            <img src="{{ asset('storage/' . (optional($firstsurat->tandatangan2)->tandatangan ?? '')) }}"
                 alt="Tanda Tangan"
                 style="max-height:40px;">
        @elseif(optional($firstsurat->tandatangan2)->tandatangan ?? false)
...
<td style="text-align:center;">
    <div>
        @if(optional($firstsurat->tandatangan3)->tandatangan && file_exists(storage_path('app/public/' . (optional($firstsurat->tandatangan3)->tandatangan ?? ''))))
            <img src="{{ asset('storage/' . (optional($firstsurat->tandatangan3)->tandatangan ?? '')) }}"
                 alt="Tanda Tangan"
                 style="max-height:40px;">
        @elseif(optional($firstsurat->tandatangan3)->tandatangan ?? false)
