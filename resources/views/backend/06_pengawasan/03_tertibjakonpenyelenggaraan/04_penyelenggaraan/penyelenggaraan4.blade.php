...
<section style="background: linear-gradient(to bottom, #a8f0c6, #ffffff); width: 100%; min-height: 100vh;">
    ...
    @if ($datasurat->isEmpty())
        <a href="{{ route('betertibjakonpenyelenggaraan4create', ['id' => $id]) }}">
        ...
        {{ $tertibStatus }}
                                        ...
                                        <td style="text-align: center;">
                                         ...
                                         function setDeleteUrl(button) {
                                             ...
                                             var deleteUrl = "{{ route('betertibjakonpenyelenggaraan4delete', ':id') }}";
    ...
    <tr>
        <td colspan="100%"> {{-- Memenuhi semua kolom --}}
            ...
            ">
                ...
                Berkas Dukung Pengawasan Terhadap Manajemen Mutu Konstruksi Tidak Di Temukan !!
            </div>
        </td>
    </tr>
@endforelse
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            {{-- <input type="hidden"  name="tertibjakonpemanfaatan_id" value="{{ $datatertibjasakonstruksi_id }}"> --}}
                                ...
                                <div class="modal-content" style="font-size: 0.875rem;">
                                    ...
                                    <br>
                                    <div class="modal-body">
                                        <h5 style="font-size: 15px;">Surat Dukung Tertib Jakon Penyelenggaraan : Pengawasan Tertib Penyelenggaraan Konstruksi Secara Rutin <br> Penyelenggaraan Konstruksi dengan Sumber Dana dari APBD <br> <strong> Pengawasan Terhadap Manajemen Jasa Konstruksi</strong></h5>
                                            <br>
...
<tr>
  ...
  <tbody>
    <tr>
        ...
        <td style="border: 1px solid #000; padding: 5px;" rowspan="2">Pengawasan Terhadap Penerapan Manajemen Mutu Konstruksi </td>
        <td style="border: 1px solid #000; padding: 5px;">Sistem Manajemen Mutu Konstruksi Dilakukan sesuai ketentuan peraturan perundang-undangan tentang sistem manajemen mutu</td>
        <td style="border: 1px solid #000; padding: 5px;">Surat Pernyataan dari Kuasa Pengguna anggaran atau pejabat pembuat komitmen bahwa sudah memenuhi ketentuan dalam penerapan sistem manajemen mutu</td>
...
<!-- Tombol Submit -->
   ...
   <div class="modal fade" id="modalKtp{{ $datasurat_id }}" tabindex="-1" aria-labelledby="modalKtpLabel{{ $datasurat_id }}" aria-hidden="true">
                                        ...
                                        <div class="modal-content" style="font-size: 0.875rem; margin-top:-10px;" >
                                            ...
                                            <div class="modal-body">
                                                <h5 style="font-size: 1rem;">Surat Dukung Tertib Jakon Penyelenggaraan : <br> Pengawasan Tertib Penyelenggaraan Konstruksi Secara Rutin <br> Penyelenggaraan Konstruksi dengan Sumber Dana dari APBD <br> <strong> Pengawasan Terhadap Manajemen Jasa Konstruksi</strong> </h5>
                                                {{-- <table class="table table-bordered table-sm" style="font-size: 14px;"> --}}
                                                   {{-- <tr>
...
<script>
    function downloadModalPDF(id) {
        ...
        clone.style.padding = '10px'; // padding isi konten

        // Format nama file
        const fileName = `Tertibjakonpenyelenggaraan_surat4_${id}.pdf`;

        // Konversi ke PDF dan download
        html2pdf()
            .from(clone)
            .set({
                margin: [0.1, 0.2, 0.2, 0.2], // atas 0.1 inch (~8px), kiri/kanan/bawah 0.2 inch (~5px)
                filename: fileName,
