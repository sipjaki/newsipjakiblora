...
<section style="background: linear-gradient(to bottom, #a8f0c6, #ffffff); width: 100%; min-height: 100vh;">
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                        <form action="{{ route('betertibjakonpenyelenggaraan3createnew') }}" method="POST" enctype="multipart/form-data">
                            @csrf
...
<td style="border: 1px solid #000; text-align: center;">
    <select class="form-control @error('catatan1') is-invalid @enderror" name="catatan1">
        <option value="">-- Pilih --</option>
        <option value="Sesuai" {{ old('catatan1') == 'Sesuai' ? 'selected' : '' }}>Tersedia</option>
        <option value="Tidak Sesuai" {{ old('catatan1') == 'Tidak Sesuai' ? 'selected' : '' }}>Tidak Tersedia</option>
    </select>
    @error('catatan1')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
