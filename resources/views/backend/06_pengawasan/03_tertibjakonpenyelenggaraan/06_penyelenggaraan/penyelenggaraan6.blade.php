...
<section style="background: linear-gradient(to bottom, #a8f0c6, #ffffff); width: 100%; min-height: 100vh;">
    ...
    @if ($datasurat->isEmpty())
        <a href="{{ route('betertibjakonpenyelenggaraan6create', ['id' => $id]) }}">
        ...
        {{ $tertibStatus }}
                                        ...
                                        <td style="text-align: center;">
                                         ...
                                         function setDeleteUrl(button) {
                                             ...
                                             var deleteUrl = "{{ route('betertibjakonpenyelenggaraan6delete', ':id') }}";
    ...
    <tr>
        <td colspan="100%"> {{-- Memenuhi semua kolom --}}
            ...
            ">
                ...
                Berkas Dukung Pengawasan Terhadap Pengelolaan & Pemanfaatan Sumber Material Tidak Di Temukan !!
            </div>
        </td>
    </tr>
@endforelse
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            {{-- <input type="hidden"  name="tertibjakonpemanfaatan_id" value="{{ $datatertibjasakonstruksi_id }}"> --}}
                                ...
                                <div class="modal-content" style="font-size: 0.875rem;">
                                    ...
                                    <br>
                                    <div class="modal-body">
                                        <h5 style="font-size: 15px;">Surat Dukung Tertib Jakon Penyelenggaraan : Pengawasan Tertib Penyelenggaraan Konstruksi Secara Rutin <br> Penyelenggaraan Konstruksi dengan Sumber Dana dari APBD <br> <strong>Pengawasan Terhadap Pengelolaan & Pemanfaatan Sumber Material </strong></h5>
                                            <br>
...
<!-- Tombol Submit -->
   ...
   <div class="modal fade" id="modalKtp{{ $datasurat_id }}" tabindex="-1" aria-labelledby="modalKtpLabel{{ $datasurat_id }}" aria-hidden="true">
                                        ...
                                        <div class="modal-content" style="font-size: 0.875rem; margin-top:-10px;" >
                                            ...
                                            <div class="modal-body">
                                                <h5 style="font-size: 1rem;">Surat Dukung Tertib Jakon Penyelenggaraan : <br> Pengawasan Tertib Penyelenggaraan Konstruksi Secara Rutin <br> Penyelenggaraan Konstruksi dengan Sumber Dana dari APBD <br> <strong>Pengawasan Terhadap Pengelolaan & Pemanfaatan Sumber Material </strong> </h5>
                                                {{-- <table class="table table-bordered table-sm" style="font-size: 14px;"> --}}
                                                   {{-- <tr>
...
<script>
    function downloadModalPDF(id) {
        ...
        clone.style.margin = '0'; // pastikan tidak ada margin default

        // Format nama file
        const fileName = `Tertibjakonpenyelenggaraan_surat6_${id}.pdf`;

        // Konversi ke PDF dan download
        html2pdf()
            .from(clone)
            .set({
                margin: [10, 10, 10, 10], // top, right, bottom, left (10px)
                filename: fileName,
                image: { type: 'jpeg', quality: 0.98 },
                html2canvas: { scale: 2, scrollY: 0 },
                jsPDF: { unit: 'px', format: [1123, 794], orientation: 'landscape' }
                // 1123x794 px = ukuran A4 landscape
            })
            .save();
    }
</script>
