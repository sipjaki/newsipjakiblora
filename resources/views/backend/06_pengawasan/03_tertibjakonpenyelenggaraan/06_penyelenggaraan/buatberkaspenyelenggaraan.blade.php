...
<section style="background: linear-gradient(to bottom, #a8f0c6, #ffffff); width: 100%; min-height: 100vh;">
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                        <form action="{{ route('betertibjakonpenyelenggaraan6createnew') }}" method="POST" enctype="multipart/form-data">
                            @csrf
...
<table style="width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 20px; border: 1px solid #000;">
   ...
   <tbody>
    <tr>
        <td style="border: 1px solid #000; text-align: center; padding: 5px;">6</td>
        <td style="border: 1px solid #000; padding: 5px;" rowspan="2">Pengawasan Terhadap pengelolaan dan pemanfaatan sumber material Konstruksi </td>
        <td style="border: 1px solid #000; padding: 5px;">a. Pemenuhan terhadap standar teknis lingkungan </td>
        <td style="border: 1px solid #000; padding: 5px;">Surat Pernyataan dari Kuasa Pengguna anggaran atau pejabat pembuat komitmen bahwa sudah memenuhi ketentuan dalam pengelolaan dan pemanfaatan sumber material konstruksi berdasarkan surat pernyataan dari pimpinan BUJK</td>
    ...
    <tr>
        ...
        <td style="border: 1px solid #000; padding: 5px;">b. Pemenuhan terhadap standar nasional indonesia atau standar yang berlaku lainnya</td>
        <td style="border: 1px solid #000; padding: 5px;"></td>
