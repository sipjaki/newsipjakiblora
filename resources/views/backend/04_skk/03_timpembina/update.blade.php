...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            {{-- <form action="/beritaagendaupdatestore/{{$beritaagenda->nama_agenda}}" method="POST"> --}}
                <form action="/timpembinaupdatestore/{{$data->nama_lengkap}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="text" class="form-control" id="jabatandalamkedinasan" name="jabatandalamkedinasan" value="{{ old('jabatandalamkedinasan', $data->jabatandalamkedinasan) }}" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <div class="preview-container">
                            <img id="fototimpembina-preview" src="{{ asset('storage/' . $data->fototimpembina) }}" alt="Preview" class="img-preview" style="max-width: 100px; margin-right: 10px;" />
