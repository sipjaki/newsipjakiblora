...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badgekembali" style="margin-right: 400px;"><i class="fas fa-plus-circle mr-2"></i>Create Tim Pembina Jasa Konstruksi</div>
        </a>
        ...
        <div class="container-update" style="col-lg-12">
            ...
            {{-- <form action="/beritaagendaupdatestore/{{$beritaagenda->nama_agenda}}" method="POST"> --}}
                {{-- <form action="{{ route('create.pengawasandanketertiban') }}" method="POST">
                    @csrf --}}
                    <form action="{{ route('create.timpembina') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="jabatandalamkedinasan" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-briefcase me-2"></i> Jabatan Kedinasan
                            </label>
                            <input style="text-transform: uppercase;" type="text" id="jabatandalamkedinasan" name="jabatandalamkedinasan" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group d-flex align-items-center mt-3">
                            ...
                            <input style="text-transform: uppercase;" type="number" id="telepon" name="telepon" class="form-control" required>
                        </div>
                        
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="fototimpembina" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-image me-2"></i> Foto Pembina
                            </label>
                            <div class="preview-container">
                                <img id="fototimpembina-preview" src="#" alt="Preview" class="img-preview" style="max-width: 100px; margin-right: 10px; display: none;" />
                                <input type="file" id="fototimpembina" name="fototimpembina" accept="image/*" required>
                            </div>
                        </div>
                        
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                const fileInput = document.getElementById('fototimpembina');
                                const preview = document.getElementById('fototimpembina-preview');
