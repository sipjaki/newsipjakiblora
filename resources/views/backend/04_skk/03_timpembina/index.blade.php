             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase">{{ $item->jabatandalamkedinasan}}</td>
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase">{{ $item->nama_lengkap}}</td>
                        <td style="font-size: 12px; text-align:left;">{{ $item->email}}</td>
                        {{-- <td style="font-size: 12px; text-align:left; text-transform:uppercase">{{ $item->alamatkantor}}</td> --}}
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase">{{ $item->telepon}}</td>
                        
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase">
                            <img style="width: 80%;" src="{{ asset('storage/' . $item->fototimpembina)}}" alt="">
                        </td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/datapjt/{{$item->nama_lengkap}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="/timpembina/update/{{$item->nama_lengkap}}" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.timpembina', $item->nama_lengkap) }}')">
