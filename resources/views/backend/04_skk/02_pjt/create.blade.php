...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badgekembali" style="margin-right: 400px;"><i class="fas fa-plus-circle mr-2"></i>Create Penanggung Jawab Teknis Jasa Konstruksi</div>
        </a>
        ...
        <div class="container-update" style="col-lg-12">
            ...
            {{-- <form action="/beritaagendaupdatestore/{{$beritaagenda->nama_agenda}}" method="POST"> --}}
                {{-- <form action="{{ route('create.pengawasandanketertiban') }}" method="POST">
                    @csrf --}}
                    <form action="{{ route('create.datapjt') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="pengawasanlokasi_id" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-map-marked-alt me-2"></i> Kecamatan
                            </label>
                        ...
                        <div class="form-group d-flex align-items-center mt-3">
                            ...
                            <input style="text-transform: uppercase;" type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" required>
                        </div>
                        
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="nopjt" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-id-card me-2"></i> No PJT
                            </label>
                            <input style="text-transform: uppercase;" type="number" id="nopjt" name="nopjt" class="form-control" required>
                        </div>
                        
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="sfesifikasi" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-cogs me-2"></i> Spesifikasi Keahlian
                            </label>
                            <input style="text-transform: uppercase;" type="text" id="sfesifikasi" name="sfesifikasi" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group d-flex align-items-center mt-3">
                            ...
                            <input style="text-transform: uppercase;" type="date" id="tanggal_terbit" name="tanggal_terbit" class="form-control" required>
                        </div>
                        
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="masa_berlaku" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-calendar-check me-2"></i> Masa Berlaku
                            </label>
                            <input style="text-transform: uppercase;" type="date" id="masa_berlaku" name="masa_berlaku" class="form-control" required>
                        </div>
                        
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="foto_pjt" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-image me-2"></i> Foto PJT
                            </label>
                            <div class="preview-container">
                                <img id="foto_pjt-preview" src="#" alt="Preview" class="img-preview" style="max-width: 100px; margin-right: 10px; display: none;" />
                                <input type="file" id="foto_pjt" name="foto_pjt" accept="image/*" required>
                            </div>
                        </div>
