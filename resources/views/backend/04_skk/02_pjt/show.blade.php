    ...
    <tbody>
        ...
        <tr>
            <td style="width: 150px; padding: 10px; vertical-align: top;">
                ...
                @if(Storage::disk('public')->exists($data->foto_pjt))
                <img src="{{ asset('storage/' . $data->foto_pjt) }}" alt="{{ $data->foto_pjt }}" style="width: 100%; min-width: 280px; height: auto; border-radius: 8px;">
            @else
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->nama_lengkap)) }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->sfesifikasi)) }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ \Carbon\Carbon::parse($data->tanggal_terbit)->locale('id')->translatedFormat('d F Y') }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ \Carbon\Carbon::parse($data->masa_berlaku)->locale('id')->translatedFormat('d F Y') }}
                        </td>
                    </tr>
