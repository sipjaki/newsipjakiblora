             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        {{-- <td style="font-size: 12px; text-align:left;">{{ $item->qasebagai->subjekyangbertanya}}</td> --}}
                        {{-- <td style="font-size: 12px; text-align:left;">{{ $item->qasebagai->sebagai}}</td> --}}
                        <td style="font-size: 12px; text-align:left;">{{ $item->qapertanyaan->pertanyaan}}</td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/pergubernur/{{$item->judul}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.qapertanyaan', $item->nama_lengkap) }}')">
