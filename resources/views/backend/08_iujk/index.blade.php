             ...
             <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:200px; font-size:12px;">NAMA PERUSAHAAN</th>
                        <th style="width:100px; font-size:12px;">KATEGORI</th> 
                        <th style="width:200px; font-size:12px;">KLASIFIKASI BIDANG USAHA</th> 
                        {{-- <th style="width:100px; font-size:12px;">SUB KLASIFIKASI BIDANG USAHA</th>  --}}
                        {{-- <th style="width:100px; font-size:12px;">KETERANGAN </th>  --}}
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase">{{ $item->nama_perusahaan}}</td>
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase">{{ $item->kategori_perusahaan}}</td>
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase">{{ $item->klasifikasi_bidang_usaha}}</td>
                        {{-- <td style="font-size: 12px; text-align:left; text-transform:uppercase">{{ $item->sub_klasifikasi_bidang_usaha}}</td>
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase">{{ $item->keterangan}}</td> --}}
                        {{-- <td> --}}
                        <td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/dataiujk/{{$item->nama_perusahaan}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                                <a href="/dataiujk/update/{{$item->nama_perusahaan}}" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.dataiujk', $item->nama_perusahaan) }}')">
