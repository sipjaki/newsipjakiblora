...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badgekembali" style="margin-right: 400px;"><i class="fas fa-plus-circle mr-2"></i>Create Ijin Usaha Jasa Konstruksi</div>
        </a>
        ...
        <div class="container-update" style="col-lg-12">
            ...
            {{-- <form action="/beritaagendaupdatestore/{{$beritaagenda->nama_agenda}}" method="POST"> --}}
                {{-- <form action="{{ route('create.pengawasandanketertiban') }}" method="POST">
                    @csrf --}}
                    <form action="{{ route('create.dataiujk') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="form-group d-flex align-items-center mt-3">
                            ...
                            <input style="text-transform: uppercase;" type="text" id="nama_perusahaan" name="nama_perusahaan" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group d-flex align-items-center mt-3">
                            ...
                            <select id="kategori_perusahaan" name="kategori_perusahaan" class="form-control" required>
                        ...
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="klasifikasi_bidang_usaha" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-folder-open me-2"></i> Klasifikasi Bidang Usaha
                            </label>
                            <input style="text-transform: uppercase;" type="text" id="klasifikasi_bidang_usaha" name="klasifikasi_bidang_usaha" class="form-control" required>
                        </div>
                        
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="sub_klasifikasi_bidang_usaha" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-folder me-2"></i> Sub Klasifikasi Bidang Usaha
                            </label>
                            <input style="text-transform: uppercase;" type="text" id="sub_klasifikasi_bidang_usaha" name="sub_klasifikasi_bidang_usaha" class="form-control" required>
                        </div>
                        
                        <div class="form-group d-flex align-items-center mt-3">
                            <label for="keterangan" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                                <i class="fas fa-calendar-alt me-2"></i> Registrasi Tahun 
                            </label>
