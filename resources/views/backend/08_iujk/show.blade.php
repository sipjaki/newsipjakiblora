...
<a href="/dataiujk/update/{{$data->nama_perusahaan}}" style="background: white; display:right;">
...
<style>
 ...
 <table id="datakeluar" style="width: 100%; border-collapse: collapse;">
    <thead>
        <tr>
            <th colspan="2" style="background-color: #FFCB0F; text-align: center; font-size: 16px;">Data Ijin Usaha Jasa Konstruksi | Pemerintah Kabupaten Bandung Barat</th>
        </tr>
    </thead>
    <tbody>
                ...
                <table style="width: 100%; border-collapse: collapse;"> --}}
                    <tr>
                        <th style="background-color: navy; width: 20px; border-radius: 10px; text-align: center;">
                            <i class="fas fa-building me-2" style="color: white; font-size: 12px;"></i>
                        </th>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->nama_perusahaan)) }}
                        </td>
                    </tr>
                    
                    <tr>
                        <th style="background-color: navy; width: 20px; border-radius: 10px; text-align: center;">
                            <i class="fas fa-th-list me-2" style="color: white; font-size: 12px;"></i>
                        </th>
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">Kategori Perusahaan</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: uppercase; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->kategori_perusahaan)) }}
                        </td>
                    </tr>
                    
                    <tr>
                        <th style="background-color: navy; width: 20px; border-radius: 10px; text-align: center;">
                            <i class="fas fa-industry me-2" style="color: white; font-size: 12px;"></i>
                        </th>
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">Klasifikasi Bidang Usaha</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->klasifikasi_bidang_usaha)) }}
                        </td>
                    </tr>
                    
                    <tr>
                        <th style="background-color: navy; width: 20px; border-radius: 10px; text-align: center;">
                            <i class="fas fa-tags me-2" style="color: white; font-size: 12px;"></i>
                        </th>
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">Sub Klasifikasi Bidang Usaha</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->sub_klasifikasi_bidang_usaha)) }}
                        </td>
                    </tr>
                    
                    <tr>
                        <th style="background-color: navy; width: 20px; border-radius: 10px; text-align: center;">
                            <i class="fas fa-info-circle me-2" style="color: white; font-size: 12px;"></i>
                        </th>
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">Keterangan Registrasi</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->keterangan)) }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4" style="background-color: white; text-align: right; padding: 10px;">
                            Ijin Usaha Jasa Konstruksi | Sistem Informasi Pembina Jasa Konstruksi Kabupaten Bandung Barat | sipjakikbb.com
...
<div style="text-align: right; margin-top: 20px;">
    ...
    <button id="downloadBtn" data-nama="{{ $data->nama_perusahaan }}" class="badge">
...
<script>
    ...
    const formattedNama = nama ? nama.replace(/[^a-zA-Z0-9]/g, '_') : '{{$data->nama_perusahaan}}';
