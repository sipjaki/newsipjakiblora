             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        {{-- <td style="font-size: 12px; text-align: left; background: inherit;">
                            <a href="/dokumentasipelatihan/{{$item->judul_kegiatan}}">
                                <span class="badge-selesai w-100 text-center">GALERY</span>
                            </a>
                        </td>
                         --}}
