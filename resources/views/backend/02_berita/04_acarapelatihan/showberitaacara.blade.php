...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <a href="/acarapelatihanupdate/{{$data->judul_kegiatan}}" style="background: white; display:right;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: justify; font-weight: 700; color: black;">
                    <span id="shortText">{{ strlen($data->keterangan_berita) > 500 ? substr($data->keterangan_berita, 0, 500) . '...' : $data->keterangan_berita }}</span>
                    <span id="fullText" style="display: none;">{{ $data->keterangan_berita }}</span>
                    @if(strlen($data->keterangan_berita) > 500)
