...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="/databeritaupdatestore/{{$berita->judul}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <textarea class="form-control" id="keterangan" name="keterangan" rows="20" style="resize: vertical;" required>{{ old('keterangan', $berita->keterangan) }}</textarea>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="preview-container">
                            <img id="gambar-preview" src="{{ asset('storage/' . $berita->gambar) }}" alt="Preview" class="img-preview" style="width: 100px; height: 100px; object-fit: cover;"/>
                        </div>
