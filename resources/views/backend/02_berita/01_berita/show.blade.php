...
<style>
 ...
 <table id="datakeluar" style="width: 100%; border-collapse: collapse;">
    <thead>
        <tr>
            <th colspan="2" style="background-color: #FFCB0F; text-align: center; font-size: 16px;">Data Berita | Pemerintah Kabupaten Bandung Barat</th>
        </tr>
    </thead>
    <tbody>
        <!-- Menyimpan nama data dalam elemen data -->
        <div id="dataContainer" data-nama="{{ $data->judul }}" style="display: none;"></div>
        ...
        <tr>
            <td style="width: 150px; padding: 10px; vertical-align: top;">
                ...
                <img src="{{ asset('storage/' . $data->gambar) }}" alt="{{ $data->gambar }}" style="width: 100%; min-width: 280px; height: auto; border-radius: 8px;">
            @else
                <img src="{{ $data->gambar }}" alt="{{ $data->gambar }}" style="width: 100%; min-width: 280px; height: auto; border-radius: 8px;">
            @endif
                            <p style="margin-top:10px;">Berita</p>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: justify; font-weight: 700; color: black;">
                            <span id="shortText">{{ strlen($data->keterangan) > 500 ? substr($data->keterangan, 0, 500) . '...' : $data->keterangan }}</span>
                            <span id="fullText" style="display: none;">{{ $data->keterangan }}</span>
                            @if(strlen($data->keterangan) > 500)
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            {{ ucwords(strtolower($data->tanggal)) }}
                        </td>
                    </tr>
                 
                    <tr>
                        <td colspan="4" style="background-color: white; text-align: right; padding: 10px;">
                            Berita Jasa Konstruksi | Sistem Informasi Pembina Jasa Konstruksi Kabupaten Bandung Barat | sipjakikbb.com
