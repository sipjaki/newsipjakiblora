...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            {{-- <form action="/databeritaupdatestore/{{$data->judul}}" method="POST" enctype="multipart/form-data">
                @csrf
             ...
             <div class="form-group d-flex align-items-center mt-3">
                ...
                <input type="text" class="form-control" id="pengawasanlokasi_id" name="pengawasanlokasi_id" value="{{ old('pengawasanlokasi_id', $data->pengawasanlokasi->kota) }}" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input type="text" class="form-control" id="pengawasanbangunangedung_id" name="pengawasanbangunangedung_id" value="{{ old('pengawasanbangunangedung_id', $data->pengawasanbangunangedung->bangunan) }}" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="penanggungjawabteknis_id" name="penanggungjawabteknis_id" value="{{ old('penanggungjawabteknis_id', $data->penanggungjawabteknis->nama_lengkap) }}" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="pengawasanstatus_id" name="pengawasanstatus_id" value="{{ old('pengawasanstatus_id', $data->pengawasanstatus->status) }}" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="pengawasantindakan_id" name="pengawasantindakan_id" value="{{ old('pengawasantindakan_id', $data->pengawasantindakan->tindakan) }}" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="judul" name="judul" value="{{ old('judul', $data->judul) }}" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="tanggal_laporan" name="tanggal_laporan" value="{{ old('tanggal_laporan', $data->tanggal_laporan) }}" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="keterangan" name="keterangan" value="{{ old('keterangan', $data->keterangan) }}" required readonly>
            </div>
