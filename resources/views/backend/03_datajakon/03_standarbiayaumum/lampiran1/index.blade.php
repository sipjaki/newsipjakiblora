                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    .iconhover i {
                        ...
                        <div class="button-container">
                            <a href="/sbulampiran1/{{$item->judul}}" class="iconhover" title="Download">
                                <button type="button" class="btn btn-success">
                                    <i class="fas fa-download"></i> Download
                                </button>
                            </a>
                            
                                {{-- <a href="/standarbiayaumum/update/{{$item->judul}}" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a> --}}

{{-- 
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.standarbiayaumum', $item->judul) }}')">
