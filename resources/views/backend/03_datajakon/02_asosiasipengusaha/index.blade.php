             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;">{{ $item->website}}</td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/asosiasipengusaha/{{$item->nama_asosiasi}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.asosiasipengusaha', $item->nama_asosiasi) }}')">
