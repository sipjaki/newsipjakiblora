...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('peruud.updateperwalikotabupati', $perwalikotabupati->judul) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="judul" name="judul" value="{{ old('judul', $perwalikotabupati->judul) }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="peraturan" name="peraturan" value="{{ old('peraturan', $perwalikotabupati->peraturan) }}">
                </div>
