...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('peruud.updatereferensi', $referensi->judul) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="judul" name="judul" value="{{ old('judul', $referensi->judul) }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="peraturan" name="peraturan" value="{{ old('peraturan', $referensi->peraturan) }}">
                </div>
