...
<div style="display: flex; align-items: center;">
    ...
    <h1 style="margin-top:10px; font-size: 16px; font-family: 'Lato', sans-serif; font-weight: 700; "><span style="color: #000000;">Dinas Kementrian Pekerjaan Umum Dan Penataan Ruang </span></h1>
    <div class="container">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('peruud.createpermenteri') }}" method="POST" enctype="multipart/form-data">
                @csrf
