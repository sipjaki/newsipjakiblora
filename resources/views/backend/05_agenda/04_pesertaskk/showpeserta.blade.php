...
<script>
  ...
  <button
    onmouseover="this.style.background = 'white'; this.style.color = 'black'; this.style.border = '1px solid #ccc';"
    onmouseout="this.style.background = 'linear-gradient(to right, black, white)'; this.style.color = 'white'; this.style.border = 'none';"
        ...
        document.getElementById("modalVerifikasiHadirLSP").style.display = "none";
                                        ...
                                        <td style="text-align: center;">
                                         ...
                                         {{-- <a href="/404" class="btn btn-sm btn-info me-2" title="Show">
                                            ...
                                            <!-- Update Icon --> --}}
                                            <a href="{{ url('/besertifikatskk/' . $item->user_id) }}" class="btn btn-sm btn-warning me-2" title="Upload Sertifikat">
