...
function exportTableToExcel(tableID, filename = ''){
    ...
    // Nama file default kalau tidak ada input
    ...
    // Browser support untuk msSaveOrOpenBlob (IE / Edge lama)
    ...
    <i class="bi bi-search"
       style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); font-size: 16px; color: #888;"></i>
                        ...
                        <script>
                            ...
                            fetch(`/beagendaskktkk?search=${input}`)
    ...
    Kembali
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive" style="overflow-x: auto; white-space: nowrap;">
                            <table id="tablepeserta" class="zebra-table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 200px; text-align:center;">
                                            <i class="bi bi-check-circle" style="margin-right: 5px;"></i>Sertifikat
                                        </th>
                                        {{-- <th style="width: 200px; text-align:center;">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h5 class="modal-title" id="modalKtpLabel{{ $item->id }}">
                                                                Sertifikat : <i class="bi bi-file-earmark-pdf-fill text-danger"></i>
                                                            </h5>
