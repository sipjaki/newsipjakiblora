...
<section style="background: linear-gradient(to bottom, #a8f0c6, #ffffff); width: 100%; min-height: 100vh;">
    ...
    <div class="mt-2">
        ...
        @if ($materiPath)
            <iframe id="pdfPreview" src="{{ $fileInStorage ? asset('storage/' . $materiPath) : asset($materiPath) }}"
                width="100%" height="500px" style="border:1px solid #ccc;"></iframe>
        @else
            <iframe id="pdfPreview" width="100%" height="500px" style="border:1px solid #ccc; display:none;"></iframe>
            <p id="noFileText" class="text-muted">Belum ada file materi pelatihan.</p>
        @endif
    </div>
</div>
...
<script>
    function previewPDF(event) {
        ...
        if (file && file.type === "application/pdf") {
            ...
            if (noFileText) noFileText.style.display = "block";
        }
    }
</script>
                                </div>
                                ...
                                <div style="display: flex; justify-content: flex-end; margin-bottom:20px;">
                                    <div class="flex justify-end">
                                     ...
                                     <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                        ...
                                        <span style="font-family: 'Poppins', sans-serif;">Upload Materi Pelatihan ?</span>
                                    </button>
                                    </div>
                                    <!-- Modal Konfirmasi -->
                                    <div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
                                        <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                                          <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">
                                            Apakah Anda ingin upload materi untuk agenda ini?
                                        </p>
