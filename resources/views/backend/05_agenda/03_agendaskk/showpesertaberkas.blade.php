        ...
        <table class="zebra-table table-striped">
            <thead style="font-size: 16px; background-color: green; color: white;">
                <tr>
                    ...
                    <th style="width: 150px; text-align:center; font-size: 16px; background-color: green; color: white;">Keterangan</th>
            ...
            <tbody>
                <tr class="align-middle">
                    ...
                    <!-- Keterangan Foto -->
                    <td class="text-center">
                        @if($datapeserta->validasi_foto == 'sesuai')
                            <span class="badge bg-success">✅ Sesuai</span>
                        @elseif($datapeserta->validasi_foto == 'tidak_sesuai')
                            <span class="badge bg-danger">❌ Tidak Sesuai</span>
                        @else
                            <span class="badge bg-secondary">Belum Divalidasi</span>
                        @endif
                    ...
                    <!-- Keterangan Ijazah -->
                    <td class="text-center">
                        @if($datapeserta->validasi_ijazah == 'sesuai')
                            <span class="badge bg-success">✅ Sesuai</span>
                        @elseif($datapeserta->validasi_ijazah == 'tidak_sesuai')
                            <span class="badge bg-danger">❌ Tidak Sesuai</span>
                        @else
                            <span class="badge bg-secondary">Belum Divalidasi</span>
                        @endif
                    ...
                    <td class="text-center">
                        @if($datapeserta->validasi_pengalaman == 'sesuai')
                            <span class="badge bg-success">✅ Sesuai</span>
                        @elseif($datapeserta->validasi_pengalaman == 'tidak_sesuai')
                            <span class="badge bg-danger">❌ Tidak Sesuai</span>
                        @else
                            <span class="badge bg-secondary">Belum Divalidasi</span>
                        @endif
                    ...
                    <!-- Keterangan Kebenaran Data -->
                    <td class="text-center">
                        @if($datapeserta->validasi_kebenaran_data == 'sesuai')
                            <span class="badge bg-success">✅ Sesuai</span>
                        @elseif($datapeserta->validasi_kebenaran_data == 'tidak_sesuai')
                            <span class="badge bg-danger">❌ Tidak Sesuai</span>
                        @else
                            <span class="badge bg-secondary">Belum Divalidasi</span>
                        @endif
                    ...
                    <!-- Keterangan NPWP -->
                    <td class="text-center">
                        @if($datapeserta->validasi_npwp == 'sesuai')
                            <span class="badge bg-success">✅ Sesuai</span>
                        @elseif($datapeserta->validasi_npwp == 'tidak_sesuai')
                            <span class="badge bg-danger">❌ Tidak Sesuai</span>
                        @else
                            <span class="badge bg-secondary">Belum Divalidasi</span>
                        @endif
                    ...
                    <td class="text-center">
                        @if($datapeserta->validasi_riwayat_hidup == 'sesuai')
                            <span class="badge bg-success">✅ Sesuai</span>
                        @elseif($datapeserta->validasi_riwayat_hidup == 'tidak_sesuai')
                            <span class="badge bg-danger">❌ Tidak Sesuai</span>
                        @else
                            <span class="badge bg-secondary">Belum Divalidasi</span>
                        @endif
