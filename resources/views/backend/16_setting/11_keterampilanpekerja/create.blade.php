...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-plus mr-2"></i>Create Keterampilan Pekerja</div></label>
        </a>
        
        <a href="/settingketerampilanpekerja" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.settingketerampilanpekerja') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST') <!-- Gunakan metode PUT untuk update data -->
                
                <div class="form-group d-flex align-items-center">
                    <label for="keterampilan" class="mr-3" style="width: 200px; text-align:left; font-size: 14px;">
                        <i class="fas fa-cogs" style="font-size: 14px;"></i> Keterampilan Pekerja
                    </label>
                    <input type="text" class="form-control" id="keterampilan" name="keterampilan" required style="font-size: 14px; text-transform:uppercase;" placeholder="Masukan Keterampilan Pekerja">
                </div>
