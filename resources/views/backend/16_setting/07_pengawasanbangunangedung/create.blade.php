...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-plus mr-2"></i>Create Jenis Bangunan Gedung </div></label>
        </a>
        
        <a href="/settingpengawasanbangunangedung" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.settingpengawasanbangunangedung') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST') <!-- Gunakan metode PUT untuk update data -->
                <div class="form-group d-flex align-items-center">
                    <label for="bangunan" class="mr-3" style="width: 200px; text-align:left; font-size: 14px;">
                        <i class="fas fa-building me-2" style="font-size: 14px;"></i> Jenis Bangunan Gedung
                    </label>
                    <input type="text" class="form-control" id="bangunan" name="bangunan" required style="font-size: 14px; text-transform:uppercase;" placeholder="Masukan Jenis Bangunan Gedung">
                </div>
