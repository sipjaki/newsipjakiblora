...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            <i class="fas fa-users" style="margin-right: 5px;"></i>Daftar Status Admin Sipjaki
        </button>
        ...
        <a href="/settingstatusadmincreate" style="background: inherit">
            <button class="badge-plus" style="border: none; font-size: 14px; cursor: pointer;">
                <i class="fas fa-user-plus" style="margin-right: 5px;"></i>Create New Status
            </button>
        </a>
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:800px;; font-size:12px;">STATUS ADMIN</th>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;">{{ $item->status }}</td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/administrator/{{$item->name}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.statusadmin', $item->id) }}')">
