...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-plus mr-2"></i>Create Qa Pertanyaan </div></label>
        </a>
        
        <a href="/settingqapertanyaan" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.settingqapertanyaan') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST') <!-- Gunakan metode PUT untuk update data -->
                
                <div class="form-group d-flex align-items-center">
                    <label for="pertanyaan" class="mr-3" style="width: 200px; text-align:left; font-size: 14px;">
                        <i class="fas fa-question-circle me-2" style="font-size: 14px;"></i> Qa Pertanyaan
                    </label>
                    <input type="text" class="form-control" id="pertanyaan" name="pertanyaan" required style="font-size: 14px; text-transform:uppercase;" placeholder="Masukan Qapertanyaan">
                </div>
