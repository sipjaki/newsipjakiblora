...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
            <i class="fas fa-user-check mr-2"></i>Daftar Qa Pertanyaan
        </button>
        
        <a href="/qapertanyaan" style="background: inherit">
            <button class="badge" style="border: none; font-size: 14px; cursor: pointer;">
                <i class="fas fa-question-circle mr-2"></i>Data Pertanyaan
            </button>
        </a>
        
        <a href="/settingqapertanyaancreate" style="background: inherit">
            <button class="badge-plus" style="border: none; font-size: 14px; cursor: pointer;">
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:800px;; font-size:12px;">QA PERTANYAAN</th>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase;">{{ $item->pertanyaan }}</td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/administrator/{{$item->name}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.settingqapertanyaan', $item->id) }}')">
