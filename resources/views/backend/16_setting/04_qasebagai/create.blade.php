...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-plus mr-2"></i>Create Qa Sebagai </div></label>
        </a>
        
        <a href="/settingqasebagai" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.settingqasebagai') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST') <!-- Gunakan metode PUT untuk update data -->
                <div class="form-group d-flex align-items-center">
                    <label for="sebagai" class="mr-3" style="width: 200px; text-align:left; font-size: 14px;">
                        <i class="fas fa-user-tag me-2" style="font-size: 14px;"></i> Qa Sebagai
                    </label>
                    <input type="text" class="form-control" id="sebagai" name="sebagai" required style="font-size: 14px; text-transform:uppercase;" placeholder="Masukan QaSebagai">
                </div>
