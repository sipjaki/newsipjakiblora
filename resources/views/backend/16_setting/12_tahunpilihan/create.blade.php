...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-plus mr-2"></i>Create Tahun Registrasi</div></label>
        </a>
        
        <a href="/settingtahunpilihan" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.settingtahunpilihan') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group d-flex align-items-center">
                    <label for="tahun" class="mr-3" style="width: 200px; text-align:left; font-size: 14px;">
                        <i class="fas fa-calendar" style="font-size: 14px;"></i> Tahun Registasi
                    </label>
                    <select class="form-control" id="tahun" name="tahun" required style="font-size: 14px; text-transform:uppercase;">
