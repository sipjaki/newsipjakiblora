...
<button id="previewBtn" class="badge" style="border: none; font-size: 14px; cursor: pointer;">
    <i class="fas fa-calendar-alt mr-2"></i>Tahun Pilihan
</button>
...
<a href="/settingtahunpilihancreate" style="background: inherit">
    <button class="badge-plus" style="border: none; font-size: 14px; cursor: pointer;">
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:800px;; font-size:12px;">TAHUN PILIHAN</th>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase;">{{ $item->tahun }}</td>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/administrator/{{$item->name}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.settingtahunpilihan', $item->id) }}')">
