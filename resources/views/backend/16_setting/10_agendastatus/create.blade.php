...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-plus mr-2"></i>Create Status Agenda</div></label>
        </a>
        
        <a href="/settingagendastatus" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="{{ route('create.settingagendastatus') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group d-flex align-items-center">
                    <label for="status" class="mr-3" style="width: 200px; text-align:left; font-size: 14px;">
                        <i class="fas fa-check-circle me-2" style="font-size: 14px;"></i> Status Agenda
                    </label>
                    <input type="text" class="form-control" id="status" name="status" required style="font-size: 14px; text-transform:uppercase;" placeholder="Masukan Status Agenda">
                </div>
