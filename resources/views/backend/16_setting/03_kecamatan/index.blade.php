...
<a href="/datapjt" style="background: inherit">
    <button class="badge" style="border: none; font-size: 14px; cursor: pointer; margin-left: -25px;">
        ...
        <a href="/settingkecamatancreate" style="background: inherit">
            <button class="badge-plus" style="border: none; font-size: 14px; cursor: pointer;">
                <i class="fas fa-building" style="margin-right: 5px;"></i>Create New
            </button>
        </a>
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:800px;; font-size:12px;">KECAMATAN</th>
                    ...
                    .iconhover i {
                        ...
                        {{-- <a href="/administrator/{{$item->name}}" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('{{ route('delete.settingkecamatan', $item->id) }}')">
