...
<head>
    ...
    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="/assets/abgblora/css/plugins/all.min.css">
    <link rel="stylesheet" href="/assets/abgblora/css/plugins/flaticon.css">

    <!-- Plugins CSS -->
    <link rel="stylesheet" href="/assets/abgblora/css/plugins/bootstrap.min.css">
    <link rel="stylesheet" href="/assets/abgblora/css/plugins/swiper-bundle.min.css">
    <link rel="stylesheet" href="/assets/abgblora/css/plugins/aos.css">
    <link rel="stylesheet" href="/assets/abgblora/css/plugins/magnific-popup.css">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="/assets/abgblora/css/style.css">
...
<body>
        ...
        <div id="header" class="section header-section transparent-header" style="background: rgb(47, 44, 44)">
            <div class="container">
                ...
                <div class="header-wrap">
                    ...
                    <div class="header-logo" style="display: flex; align-items: center; justify-content: flex-start; height: 80px; gap: 15px; padding-top: 10px;">
                        ...
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <h4 style="display: flex; align-items: center; gap: 5px; margin: 0;">
                                <span style="color: navy; font-style: italic;">ABG</span>
                                <span style="color: green; font-style: italic;">BLORA</span>
                            </h4>
                            <!-- Dinas PUPR Blora (Di bawah ABG BLORA) -->
                            <h6 style="margin: 0;">
                                <span style="color: navy;">Dinas Pekerjaan Umum & Penataan Ruang Kabupaten Blora</span>
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="footer-widget-about">
                                ...
                                <h2 style="display: flex; align-items: center; gap: 5px; margin: 0;">
    ...
    <!-- JS
    ============================================ -->
    <script src="/assets/abgblora/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="/assets/abgblora/js/vendor/modernizr-3.11.2.min.js"></script>
    ...
    <script src="/assets/abgblora/js/plugins/aos.js"></script>
    <script src="/assets/abgblora/js/plugins/waypoints.min.js"></script>
    <script src="/assets/abgblora/js/plugins/back-to-top.js"></script>
    <script src="/assets/abgblora/js/plugins/jquery.counterup.min.js"></script>
    <script src="/assets/abgblora/js/plugins/appear.min.js"></script>
    <script src="/assets/abgblora/js/plugins/jquery.magnific-popup.min.js"></script>
    ...
    <!-- Main JS -->
    <script src="/assets/abgblora/js/main.js"></script>
