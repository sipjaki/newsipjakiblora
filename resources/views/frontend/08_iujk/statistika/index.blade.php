...
<div class="div">
    ...
    <div class="container" style="display:flex; justify-content: flex-end; width:200px;">
...
<div class="jumlahpekerja">
    <button style="font-size:13px;">Jumlah Ijin Usaha Jasa Konstruksi  : {{$total_data}} Perusahaan </button>
</div>
    ...
    window.onload = function () {
        ...
        var chart1 = new CanvasJS.Chart("chartContainer", {
            ...
            data: [{
                ...
                indexLabel: "{name} - {y}%",
                dataPoints: {!! json_encode($data_kategoriperusahaan) !!} // Update dataPoints
            }]
        });
        chart1.render();
        ...
        var chart2 = new CanvasJS.Chart("kecamatanchartContainer", {
            ...
            data: [{
                ...
                showInLegend: false,
                toolTipContent: "{name}: <strong>{y}</strong>",
                indexLabel: "{name} - {y} Perusahaan",
                dataPoints: {!! json_encode($data_bidangusaha) !!} // Update dataPoints
            }]
        });
        chart2.render();
        ...
        var chart3 = new CanvasJS.Chart("desachartContainer", {
            ...
            data: [{
                ...
                legendText: "Daftar Registrasi Perusahaan",
                dataPoints: {!! json_encode($data_keterangan) !!} // Update dataPoints
            }]
        });
        chart3.render();
