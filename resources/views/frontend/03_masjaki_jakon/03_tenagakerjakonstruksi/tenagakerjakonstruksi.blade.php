    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex gap-[30px] items-center flex-wrap text-sm sm:text-base">
          <span>/</span>
          <a href="#" class="font-medium text-blue-600" style="font-size: 16px;" style="color: blue">
            {{$title}}
          </a>
          <span>/</span>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                @if(!empty($item->statusterbit))
                                    <button class="btn-success" style="padding: 6px 16px; font-size: 11px; border-radius: 4px; line-height: 1;">
                                        {{ $item->statusterbit ?? 'Data Tidak Ditemukan' }}
                                    </button>
                                @else
                                    <button class="btn-navy" style="padding: 6px 16px; font-size: 11px; border-radius: 4px; line-height: 1;">
                                        Data Belum Diupdate
                                    </button>
                                @endif
                            </td>
