    ...
    <nav>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" style="min-width: 280px;">
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-bullhorn" style="margin-left: 3px; margin-right: 8px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/berita" style="color: black; text-decoration: none; text-align:left">BERITA</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-certificate" style="margin-left: 3px; margin-right: 8px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/kegiatansertifikasi" style="color: black; text-decoration: none; text-align:left">DOKUMENTASI SERTIFIKASI</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-calendar-alt" style="margin-left: 3px; margin-right: 8px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" style="min-width: 320px;">
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-eye" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/datajakon/pengawasan" style="color: black; text-decoration: none; text-align:left">PENGAWASAN DAN KETERTIBAN</a>
                </div>
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-users" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/datajakon/asosiasi" style="color: black; text-decoration: none; text-align:left">ASOSIASI PENGUSAHA</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-money-bill-wave" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/datajakon/standarbiayaumum" style="color: black; text-decoration: none; text-align:left">STANDAR BIAYA UMUM</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-tasks" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
    ...
    {{--  
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" style="min-width: 350px;">
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-certificate" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/tenagakerja/skaskt" style="color: black; text-decoration: none; text-align:left">SERTIFIKAT KETERAMPILAN KERJA</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-user-check" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/tenagakerja/pjt" style="color: black; text-decoration: none; text-align:left">PENANGGUNG JAWAB TEKNIS (PJT)</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-users-cog" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" style="min-width: 210px;">
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-info-circle" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                    <a href="/spm/informasispm" style="color: black; text-decoration: none; text-align:left">INDIKATOR KINERJA KUNCI</a>
                </div>
                
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-chart-line" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" style="min-width: 210px;">
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-chalkboard-teacher" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
                ...
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-exclamation-triangle" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
...
{{--                  
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content" style="min-width: 250px;">
                <div style="display: inline-flex; align-items: center; color: black; text-decoration: none;">
                    <i class="fas fa-file-alt" style="margin-left: 3px; margin-right: 10px; background: linear-gradient(90deg, black, yellow); color:white;"></i>
