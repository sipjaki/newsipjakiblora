...
<style>
 ...
 <div class="max-w-[1130px] mx-auto pt-[50px] px-4 font-poppins">
    ...
    @if($data->foto && file_exists(public_path('storage/' . $data->foto)))
        ...
        <img src="{{ asset('storage/' . $data->foto) }}" alt="Poster Sertifikasi TKK" style="width: 100%; max-height: 900px; object-fit: contain;" loading="lazy">
    @elseif($data->foto)
        <!-- Menampilkan gambar dari path luar storage -->
        <img src="{{ asset($data->foto) }}" alt="Poster Sertifikasi TKK" style="width: 100%; max-height: 900px; object-fit: contain;" loading="lazy">
    @else
