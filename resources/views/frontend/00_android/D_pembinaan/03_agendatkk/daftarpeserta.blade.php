...
<div id="sktContainer" style="display: flex; justify-content: center; align-items: center; margin-top:-60px;" width="200px">
    <div id="sktBox" style="margin-bottom: 20px; font-family: 'Poppins', sans-serif; text-align: center; padding: 20px; border-radius: 15px; transition: background 0.3s ease; border: 1px solid #ddd; width:400px; height:250px;">
