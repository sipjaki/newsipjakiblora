                    ...
                    <body>
                        ...
                        <div class="table-wrapper" style="position: relative;">
                            ...
                            <div style="overflow-x: auto; -webkit-overflow-scrolling: touch; margin-top: 15px;">
                                <table class="costum-fl-table" id="sortableTable" style="min-width: 1000px; border-collapse: collapse;">
                                    <thead>
                                        <tr>
                                        ...
                                        <tr style="background-color: {{ $loop->iteration % 2 == 0 ? '#f2f2f2' : 'white' }};">
                                            ...
                                            <td style="text-align: center" style="padding: 10px;">
                                                ...
                                                onmouseout="this.style.backgroundColor='navy'; this.style.color='white';">
                                                    <a href="/resskkpeserta/{{$item->namakegiatan}}" style="color: inherit; text-decoration: none;">
