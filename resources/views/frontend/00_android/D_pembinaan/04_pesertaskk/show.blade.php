                            ...
                            <div style="overflow-x: auto; -webkit-overflow-scrolling: touch; margin-top: 15px;">
                                <table class="custom-fl-table" id="sortableTable" style="min-width: 1000px; border-collapse: collapse;" style="fixed;">
                                    <thead>
                                        ...
                                        <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:400px;">Nama Lengkap</th>
                                        ...
                                        <th onclick="sortTable(4)" style="cursor:pointer; text-align:center; width:400px;">Jabatan Kerja</th>
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        <tr style="background-color: {{ $loop->iteration % 2 == 0 ? '#f2f2f2' : 'white' }};">
                                            ...
                                            <td style="padding: 10px; text-transform:uppercase;">{{$item->user->name ?? 'Data Belum lengkap'}}</td>
