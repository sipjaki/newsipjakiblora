                    ...
                    <div class="rounded-lg shadow-lg overflow-hidden w-fit">
                        <div style="margin-top: 10px;">
                            @if($data->foto && file_exists(public_path('storage/' . $data->foto)))
                                ...
                                <img src="{{ asset('storage/' . $data->foto) }}" alt="Gambar Peraturan" style="width: 100%; max-height: 500px; object-fit: contain;" loading="lazy">
                            @elseif($data->foto)
                                <!-- Menampilkan gambar dari path luar storage -->
                                <img src="{{ asset($data->foto) }}" alt="Gambar Peraturan" style="width: 100%; max-height: 500px; object-fit: contain;" loading="lazy">
                            @else
