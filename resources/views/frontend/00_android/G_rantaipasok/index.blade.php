            ...
            <div class="header flex flex-col" style="background-image: url('/assets/00_android/iconmenu/menuutama1.jpg'); background-size: cover; background-position: center; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px; overflow: hidden; height: 350px;">
                ...
                <nav class="pt-5 px-3 flex justify-between items-center">
                    ...
                    <div class="flex flex-col gap-4 px-4" style="margin-top: -100px;">
                        ...
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Asuransi Jasa Konstruksi</p>
                        </p>
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Material Bahan Bangunan</p>
                        </p>
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Peralatan Konstruksi</p>
                        </p>
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Toko Bangunan Kabupaten Blora</p>
                        </p>
