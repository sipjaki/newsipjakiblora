...
<section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden pb-[134px]">
        <div class="header flex flex-col bg-gradient-to-b from-[#4CAF50] to-[#EAD380] rounded-b-[50px] overflow-hidden">
            {{-- <div class="header flex flex-col bg-gradient-to-b from-[#4CAF50] to-[#FFD100] rounded-b-[50px] overflow-hidden"> --}}
