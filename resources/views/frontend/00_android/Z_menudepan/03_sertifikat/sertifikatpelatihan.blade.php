...
<div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
  <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-4">
      <h2 class="text-2xl font-bold text-white text-center">🔍 Pencarian NIK</h2>
    </div>
    <div class="p-6">
      <label for="nik" class="block text-sm font-medium text-gray-600 mb-2">Masukkan Nomor Induk Kependudukan (NIK)</label>
      <div class="relative mb-4">
        ...
        <input
          ...
          class="w-full pl-10 pr-24 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none text-gray-700 shadow-sm transition duration-200"
        />
        <button
          type="submit"
          class="absolute right-2 top-2 bottom-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center justify-center"
        >
      ...
      <p class="text-xs text-gray-500 text-center">Pastikan NIK yang dimasukkan sesuai dengan KTP</p>
    </div>
  </div>
</div>
