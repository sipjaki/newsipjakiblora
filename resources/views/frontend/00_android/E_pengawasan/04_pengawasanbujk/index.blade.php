                        ...
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <div style="position: relative; display: inline-block; margin-right: 5px;">
                                    <input type="search" id="searchInput" placeholder="Cari Kegiatan Konstruksi ...." onkeyup="searchTable()"
                            ...
                            <script>
                                ...
                                fetch(`/resjakonpenyelenggaraan?search=${input}`)
                                ...
                                <table class="custom-fl-table" id="sortableTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:400px;"> Kode Proyek </th>
                                            <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:400px;"> Nama Perusahaan</th>
                                            <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:400px;"> Status Modal</th>
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;">{{$item->kodeproyek}}</td>
                                            <td style="text-align: left;">{{$item->namaperusahaan}}</td>
                                            <td style="text-align: left;">{{$item->statusmodal}}</td>
                                            ...
                                            {{-- <td class="text-center" style="text-align: center;">
                                                @php
                                                    ...
                                                    $style = '';
                                                    $route = !empty($item->surattertibjakonpenyelenggaraan1) ? route('surattertibjakonpenyelenggaraan1.show', $item->surattertibjakonpenyelenggaraan1->id) : '#';
                                                    if ($buttonText == 'LIHAT') {
