                    ...
                    <div class="flex flex-col gap-[10px]">
                        ...
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <script>
                                ...
                                fetch(`/resjakonusaha?search=${input}`)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="text-align: center;">
                                                @php
                                                    ...
                                                    $style = '';
                                                    $route = !empty($item->surattertibjakonpemanfaatan1) ? route('surattertibjakonpemanfaatan1.show', $item->surattertibjakonpemanfaatan1->id) : '#';
                                                    if ($buttonText == 'LIHAT') {
                                            ...
                                            <td class="text-center" style="text-align: center;">
                                                @php
                                                    $buttonText = !empty($item->surattertibjakonpemanfaatan2) ? 'LIHAT' : 'TIDAK ADA DATA';
                                                    $style = '';
                                                    $route = !empty($item->surattertibjakonpemanfaatan2) ? route('surattertibjakonpemanfaatan2.show', $item->surattertibjakonpemanfaatan2->id) : '#';
                                                    if ($buttonText == 'LIHAT') {
                                                        $style = 'background-color: #808080; color: white; padding: 4px 8px; font-size: 0.875rem; border-radius: 4px; transition: background-color 0.3s;';
                                                    } else {
                                                        $style = 'background-color: #dc2626; color: white; padding: 4px 8px; font-size: 0.875rem; border-radius: 4px; border: 2px solid #000000; transition: background-color 0.3s;';
                                            ...
                                            <td class="text-center" style="text-align: center;">
                                                @php
                                                    $buttonText = !empty($item->surattertibjakonpemanfaatan3) ? 'LIHAT' : 'TIDAK ADA DATA';
                                                    $style = '';
                                                    $route = !empty($item->surattertibjakonpemanfaatan3) ? route('surattertibjakonpemanfaatan3.show', $item->surattertibjakonpemanfaatan3->id) : '#';
                                                    if ($buttonText == 'LIHAT') {
                                                        $style = 'background-color: #808080; color: white; padding: 4px 8px; font-size: 0.875rem; border-radius: 4px; transition: background-color 0.3s;';
                                                    } else {
                                                        $style = 'background-color: #dc2626; color: white; padding: 4px 8px; font-size: 0.875rem; border-radius: 4px; border: 2px solid #000000; transition: background-color 0.3s;';
                                            ...
                                            <td class="text-center" style="text-align: center;">
                                                @php
                                                    ...
                                                    $style = '';
                                                    $route = !empty($item->surattertibjakonpemanfaatan4) ? route('surattertibjakonpemanfaatan4.show', $item->surattertibjakonpemanfaatan4->id) : '#';
                                                    if ($buttonText == 'LIHAT') {
                                                        $style = 'background-color: #808080; color: white; padding: 4px 8px; font-size: 0.875rem; border-radius: 4px; transition: background-color 0.3s;';
                                                    } else {
                                                        $style = 'background-color: #dc2626; color: white; padding: 4px 8px; font-size: 0.875rem; border-radius: 4px; border: 2px solid #000000; transition: background-color 0.3s;';
