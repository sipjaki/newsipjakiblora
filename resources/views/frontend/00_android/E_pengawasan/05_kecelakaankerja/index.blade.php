                    ...
                    <div class="flex flex-col gap-[10px]">
                        ...
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <script>
                                ...
                                fetch(`/reskecelakaankerja?search=${input}`)
                                ...
                                <table class="custom-fl-table" id="sortableTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:400px;"> Paket Pekerjaan </th>
                                            <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:400px;"> Tahun </th>
