                ...
                <nav class="pt-5 px-3 flex justify-between items-center">
                    ...
                    <div class="flex flex-col gap-4 px-4">
                        ...
                        <a href="/resahspdiv1" class="card">
                            <div class="w-full border border-[#E8E9EE] flex items-center p-[14px] gap-3 rounded-2xl bg-white">
                                <div class="w-16 h-[60px] flex shrink-0 rounded-2xl overflow-hidden">
                                    <img src="/assets/00_android/00_iconmenuutama/01_menuberita/divisipekerjaan.jpg" class="w-full h-full object-cover" alt="thumbnail" loading="lazy">
                                </div>
                        ...
                        <a href="/resahspdiv3" class="card">
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Divisi III Pekerjaan Arsitektur </p>
                        </p>
                        ...
                        <a href="/resahspdiv4" class="card">
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Divisi IV Pekerjaan Lansekap </p>
                        </p>
                        ...
                        <a href="/resahspdiv5" class="card">
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Divisi V Pekerjaan Mekanikal Elektrikal </p>
                        </p>
                        ...
                        <a href="/resahspdiv6" class="card">
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Divisi VI Pekerjaan Plumbing </p>
                        </p>
                        ...
                        <a href="/resahspdiv7" class="card">
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Divisi VII Pekerjaan Jalan Pada Permukiman </p>
                        </p>
                        ...
                        <a href="/resahspdiv8" class="card">
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Divisi VIII Drainase Jalan </p>
                        </p>
                        ...
                        <a href="/resahspdiv9" class="card">
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Divisi IX Pekerjaan Jaringan Pipa di Luar Gedung </p>
                        </p>
