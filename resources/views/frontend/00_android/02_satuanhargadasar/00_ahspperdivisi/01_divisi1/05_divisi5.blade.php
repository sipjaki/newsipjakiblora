...
<button class="button-baru" onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_satuanhargamaterial')">
...
<table id="tabelBujkkonstruksi" class="zebra-table table-striped" >
 <thead>
    <tr>
        ...
        <th style="width: 150px; text-align: left;">Divisi</th>
        <th style="width: 150px; text-align: left;">Paket</th>
        <th style="width: 130px; text-align: left;">Kode Pekerjaan</th>
        {{-- <th style="width: 130px; text-align: left;">Sub Harga Div1</th>
        <th style="width: 130px; text-align: left;">Bahan</th>
        <th style="width: 130px; text-align: left;">Peralatan</th> --}}
        <th style="width: 100px; text-align: left;">Kode</th>
        <th style="width: 220px; text-align: left;">Jenis Pekerjaan</th>
        <th style="width: 120px; text-align: left;">Satuan Material</th>
        <th style="width: 40px; text-align: center;">Rp</th>
 ...
 <tbody id="tableBody">
     ...
     <tr class="align-middle">
         <td style="text-align: center;">{{ $loop->iteration }}</td>
           <td style="text-align: left;">{{ $item->hspdivisi->hspdivisi ?? '-' }}</td>
        <td style="text-align: center;">{{ $item->hsppaket5->hsppaket5 ?? '-' }}</td>
        <td style="text-align: center;">{{ $item->hspkodepekerjaan5->kodepekerjaan ?? '-' }}</td>
        {{-- <td style="text-align: left;">{{ $item->subhargadiv1->subhargadiv1 ?? '-' }}</td>
        <td style="text-align: left;">{{ $item->subhargadiv1bahan->subhargadiv1bahan ?? '-' }}</td>
        <td style="text-align: left;">{{ $item->subhargadiv1peralatan->subhargadiv1peralatan ?? '-' }}</td> --}}
        <td style="text-align: center;">{{ $item->kode }}</td>
        <td style="text-align: left;">{{ $item->jenispekerjaan }}</td>
        <td style="text-align: left;">{{ $item->satuanmaterial }}</td>
        <td style="text-align: center;">Rp</td>
        <td style="text-align: right;">{{ number_format($item->hargasatuan, 0, ',', '.') }},00</td>
