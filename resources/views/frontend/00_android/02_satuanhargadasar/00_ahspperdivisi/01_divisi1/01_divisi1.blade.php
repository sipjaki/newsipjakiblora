...
<button class="button-berkas" onclick="exportTableToExcel('tabelBujkkonstruksi', 'data_satuanhargamaterial')">
...
<table id="tabelBujkkonstruksi" class="zebra-table table-striped" >
 ...
 <tbody id="tableBody">
     ...
     <tr class="align-middle">
        ...
        <td style="text-align: center;">{{ $item->hsppaket->hsppaket ?? '-' }}</td>
        <td style="text-align: center;">{{ $item->hspkodepekerjaan->kodepekerjaan ?? '-' }}</td>
