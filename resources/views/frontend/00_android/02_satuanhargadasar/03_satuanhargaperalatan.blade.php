                        ...
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <div style="position: relative; display: inline-block; margin-right: 5px;">
                                    <input type="search" id="searchInput" placeholder="Cari Peralatan ...." onkeyup="searchTable()"
                            ...
                            <script>
                                ...
                                fetch(`/ressatuanhargaperalatan?search=${input}`)
                            ...
                            <table class="fl-table" id="sortableTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:400px;"> Peralatan</th>
