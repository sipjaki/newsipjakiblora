                ...
                <nav class="pt-5 px-3 flex justify-between items-center">
                    ...
                    <div class="flex flex-col gap-4 px-4">
                        ...
                        <a href="/404" class="card">
                            <div class="w-full border border-[#E8E9EE] flex items-center p-[14px] gap-3 rounded-2xl bg-white hover:bg-green-500">
                                ...
                                <div class="flex flex-col gap-1">
                                    <p class="font-bold line-clamp-1 hover:line-clamp-none text-black hover:text-white">
                                        Struktur Organisasi DPUPR Kabupaten Blora
                                    </p>
                                </div>
                            </div>
                        </a>
