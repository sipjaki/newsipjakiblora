            ...
            <div class="header flex flex-col" style="background-image: url('/assets/00_android/iconmenu/menuutama1.jpg'); background-size: cover; background-position: center; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px; overflow: hidden; height: 350px;">
                ...
                <nav class="pt-5 px-3 flex justify-between items-center">
                    ...
                    <div class="flex flex-col gap-4 px-4" style="margin-top: -150px;">
                        ...
                        <a href="/resstruktur" class="card">
                            <div class="w-full border border-[#E8E9EE] flex items-center p-[14px] gap-3 rounded-2xl bg-white">
                                <div class="w-16 h-[60px] flex shrink-0 rounded-2xl overflow-hidden">
                                    <img src="/assets/00_android/00_iconmenuutama/01_menuutam/2.png" class="w-full h-full object-cover" alt="thumbnail" loading="lazy">
                                </div>

                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Struktur Organisasi DPUPR Kabupaten Blora</p>
                        </p>
                        ...
                        <a href="/resprofiljakon" class="card">
                            <div class="w-full border border-[#E8E9EE] flex items-center p-[14px] gap-3 rounded-2xl bg-white">
                                <div class="w-16 h-[60px] flex shrink-0 rounded-2xl overflow-hidden">
                                    <img src="/assets/00_android/00_iconmenuutama/01_menuutam/2.png" class="w-full h-full object-cover" alt="thumbnail" loading="lazy">
                                </div>
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Profil Jakon DPUPR Kabupaten Blora</p>
                        </p>
                            ...
                            <div class="flex flex-col gap-1">
                        <p class="font-bold line-clamp-1 hover:line-clamp-none" style="color: black;">Tupoksi DPUPR Kabupaten Blora</p>
                        </p>
