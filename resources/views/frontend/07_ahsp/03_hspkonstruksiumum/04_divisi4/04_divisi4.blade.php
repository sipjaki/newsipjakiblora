                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    @if(optional($item->hspdivisi)->id || optional($item->hsppaket4)->id || optional($item->hspkodepekerjaan4)->kodepekerjaan || $item->kode)
                                        {{ optional($item->hspdivisi)->id }}.
                                        {{ optional($item->hsppaket4)->id }}.
                                        {{ optional($item->hspkodepekerjaan4)->kodepekerjaan }}.
                                        {{ $item->kode }}
                                    @else
...
<div class="progress-wrap">
    ...
    <script>
        ...
        function redirectToPage(id) {
            ...
            window.location.href = "/satuanhargadivisi4/" + encodeURIComponent(id);
        }
    </script>
