                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    @if(optional($item->hspdivisi)->id || optional($item->hsppaket2)->id || optional($item->hspkodepekerjaan2)->kodepekerjaan || $item->kode)
...
<div class="progress-wrap">
    ...
    <script>
        ...
        function redirectToPage(id) {
            ...
            window.location.href = "/satuanhargadivisi2/" + encodeURIComponent(id);
        }
    </script>
