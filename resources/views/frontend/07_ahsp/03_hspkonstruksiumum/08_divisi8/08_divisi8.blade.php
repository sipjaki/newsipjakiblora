                        ...
                        @else
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    @if(optional($item->hspdivisi)->id || optional($item->hsppaket8)->id || optional($item->hspkodepekerjaan8)->kodepekerjaan || $item->kode)
...
<div class="progress-wrap">
    ...
    <script>
        ...
        function redirectToPage(id) {
            ...
            window.location.href = "/satuanhargadivisi8/" + encodeURIComponent(id);
        }
    </script>
