                ...
                <table class="zebra-table fl-table" id="sortableTable" style="margin-top: 15px; width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr>
                            ...
                            <th onclick="sortTable(2)" style="cursor:pointer; text-align:center; width:400px;"> Nama Badan Usaha</th>
                            <th onclick="sortTable(3)" style="cursor:pointer; text-align:center; width:300px;"> Nama Pekerjaan </th>
