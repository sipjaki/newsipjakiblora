                            ...
                            <div class="event-card-image-inner">
                                ...
                                <div class="event-card-meta">
                                    ...
                                    <div class="event-meta-date">
                                        <span style="font-family: 'Poppins', sans-serif;">{{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('l, d F Y') }}</span>
                                    </div><!-- event-meta-date -->
                                </div><!-- event-card-meta -->
   ...
   <!-- Konten Data -->
    <div class="full-width-container mx-auto px-4 pb-10">
        ...
        @endif
            ...
            <section class="event-three-section" style="margin-top: -150px;">
                <div class="event-section-outer">
            ...
            <section class="cta-two-section bg-light py-5">
                <div class="container">
                    <div class="cta-two-section-inner bg-white p-4 p-md-5 rounded-3 shadow-sm">
                        <div class="row align-items-center justify-content-between">
                            <!-- Left Content -->
                            <div class="col-md-7 mb-4 mb-md-0">
                                <div class="d-flex flex-column flex-sm-row align-items-center">
                                    <div class="d-flex align-items-center mb-3 mb-sm-0 me-sm-4">
                                        <h3 class="cta-title mb-0 text-primary fw-bold me-3">Klik Kami</h3>
                                        <a href="/kritikdansaran" class="icon-hover text-decoration-none">
                                    ...
                                    <h3 class="cta-title mb-0 text-dark fw-bold text-center text-sm-start">
                            ...
                            <div class="col-md-5 text-md-end">
                                <a href="form-kritik-saran.html"
                                   class="btn btn-primary btn-lg px-4 px-lg-5 py-3 rounded-pill fw-bold shadow-sm"
                                   role="button">
                                    <i class="fa-solid fa-pen-to-square me-2"></i> Kirim Saran
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <style>
                    .cta-two-section-inner {
                        max-width: 1200px;
                        margin: 0 auto;
                    }
                    .icon-hover:hover .cta-two-card-icon {
