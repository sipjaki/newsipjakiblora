...
<table>
        ...
        $start = ($data->currentPage() - 1) * $data->perPage() + 1;
            ...
            <tr>
                ...
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;">{{ $item->statusprogram }}</td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;">{{ $item->nama_agenda }}</td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;">{{ $item->keterangan }}</td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;">{{ $item->kuota }} Orang</td>
                {{-- <td style="font-size: 12px; text-transform: uppercase; text-align:left;">{{ $item->kuota }}</td> --}}
