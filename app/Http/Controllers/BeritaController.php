                        ...
                        public function acarapelatihandetailsshowbyjudul($judul_kegiatan)
                            {
                                // Mencari kegiatan berdasarkan judul
                                $kegiatanjaskon = kegiatanjaskon::all();
                                $laporankegiatan = laporankegiatan::where('judul_kegiatan', $judul_kegiatan)->first();

                                // Menggunakan paginate()
                                $user = Auth::user();

                                return view('backend.02_berita.04_acarapelatihan.showberitaacara', [
                                    'data' => $laporankegiatan,
                                    'datakegiatanjaskon' => $kegiatanjaskon,
                                    'user' => $user,
                                    'title' => 'Show Berita Acara Sertifikasi',
                                ]);
                            }

// =====================================================================================
// -------------------- UPDATE DATA ACARA PELATIHAN JASA  KONSTRUKSI ----------------------
                                        public function updateacarapelatihandetails($judul_kegiatan)
                                        {
                                            // Cari data undang-undang berdasarkan nilai 'judul'
                                            ...
                                            return view('backend.02_berita.04_acarapelatihan.updateberitaacara', [
                                                ...
                                                'datakegiatanjaskon' => $datakegiatanjaskon,
                                                'user' => $user,
                                        ...
                                        public function createupdateacarapelatihan(Request $request, $judul_kegiatan)
                                        {
                                            // Validasi input
                                            $request->validate([
                                                'kegiatanjaskon_id' => 'required|string|max:255',
                                                'judul_kegiatan' => 'required|string|max:255',
                        ...
                        public function createacarapelatihan()
                        {
                            ...
                            return view('backend.02_berita.04_acarapelatihan.create', [
                                ...
                                'datakegiatanjaskon' => $datakegiatanjaskon,
                                'datalaporankegiaran' => $datalaporankegiatan,
                        ...
                        public function createstoreacarapelatihan(Request $request)
                        {
                            ...
                            $request->validate([
                                'kegiatanjaskon_id' => 'required|string|max:255',
                                'judul_kegiatan' => 'required|string|max:255',
                                'user_id' => 'required|string|max:255', // Assuming you have a users table
                                'jabatan' => 'required|string|max:255',
                                'tanggal' => 'required|date',
                                'keterangan_berita' => 'required|string',
                            ...
                            laporankegiatan::create([
                                'kegiatanjaskon_id' => $request->input('kegiatanjaskon_id'),
                                'judul_kegiatan' => $request->input('judul_kegiatan'),
                                'user_id' => $request->input('user_id'), // Pastikan ini adalah ID pengguna
                                'jabatan' => $request->input('jabatan'),
                                'tanggal' => $request->input('tanggal'),
                                'keterangan_berita' => $request->input('keterangan_berita'),
                                'gambar' => $gambarPath,
