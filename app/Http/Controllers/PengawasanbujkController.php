...
public function bepengawasanbujkcreatenew(Request $request)
{
    $validated = $request->validate([
        ...
        'kodeproyek.required' => 'Kode Proyek Wajib Diisi !',
        'namaperusahaan.required' => 'Nama Perusahaan Wajib Diisi !',
        'alamatperusahaan.required' => 'Alamat Wajib Diisi !',
        'statusmodal.required' => 'Status Modal Wajib Diisi !',
        'jenisperusahaan.required' => 'Jenis Perusahaan Wajib Diisi !',
        'nib.required' => 'NIB Wajib Diisi !',
        'kbli.required' => 'KBLI Wajib Diisi !',
        'uraiankbli.required' => 'Uraian KBLI Wajib Diisi !',
        'sektor.required' => 'Sektor Wajib Diisi !',
        'alamatproyek.required' => 'Alamat Proyek Wajib Diisi !',
        'wilayah.required' => 'Wilayah Wajib Diisi !',
        'luastanah.required' => 'Luas Tanah Wajib Diisi !',
        'resiko.required' => 'Resiko Wajib Diisi !',
        'sumberdata.required' => 'Sumber Data Wajib Diisi !',
        'investasi.required' => 'Investasi Wajib Diisi !',
        'skalausahaperusahaan.required' => 'Skala Perusahan Wajib Diisi !',
        'skalausahaproyek.required' => 'Skala Proyek Wajib Diisi !',
        'kewenangankoordinator.required' => 'Koordinator Wajib Diisi !',
        'kewenanganpengawas.required' => 'Pengawas Wajib Diisi !',
        'PSN.required' => 'PSN Wajib Diisi !',
        'kodeproyek.max' => 'Kode proyek maksimal 100 karakter.',
        'namaperusahaan.max' => 'Nama perusahaan maksimal 255 karakter.',
        'alamatperusahaan.string' => 'Alamat perusahaan harus berupa teks.',
        'luastanah.numeric' => 'Luas tanah harus berupa angka.',
