...
Route::get('/betertibjakonusahasurat1/createnew/{id}', [TertibjasakonstruksiController::class, 'betertibjakonusahasuratnewberkas'])->middleware(['auth', 'can:super_admin'])->name('betertibjakonusahasurat1new');
