...
Route::post('/besatuanhargamaterial/updatecreate/{id}', [StrukturController::class, 'besatuanhargamaterialupdatecreate'])->middleware('auth')->name('update.besatuanhargamaterialcreateupdate');
