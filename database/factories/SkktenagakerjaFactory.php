...
class skktenagakerjaFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $kecamatan = $faker->randomElement(array_keys($this->desaByKecamatan));

        // Pilih desa secara acak berdasarkan kecamatan yang dipilih
        $desa = $faker->randomElement($this->desaByKecamatan[$kecamatan]);
        ...
        return [
            ...
            'nik' => $nik,
            'keterampilan' => $faker->randomElement($this->keterampilanList),
            'tahun_bimtek' => 'BELUM', 
            'kualifikasi' => 'BELUM',
            'registrasi' => 'BELUM',
            'usia' => $usia,
