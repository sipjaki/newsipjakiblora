...
Distribusi Data Berdasarkan Keterampilan Para Pekerja
</h2>
</div>
<style>
...
<?php echo $__env->make('tambahan.pencarianskk.menunavigasiperdaerah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="div">
    ...
    <div class="container" style="display:flex; justify-content: flex-end;">
        <div class="badge"><i class="fas fa-users me-2"></i><span><?php echo e($totaldata); ?></span> Daftar Pekerja Tukang Terampil (SKK)</div>
...
<form id="keterampilan-form" method="GET" action="<?php echo e(url('/tenagakerja/keterampilan')); ?>">
    <div class="custom-select-wrapper">
        <select name="id" id="kecamatan-dropdown" onchange="submitForm()">
            <option value="">PILIH KETERAMPILAN</option>
            <?php if($data_keterampilan && count($data_keterampilan) > 0): ?>
                <?php $__currentLoopData = $data_keterampilan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keterampilanpekerja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($keterampilanpekerja->id); ?>" <?php echo e(request('id') == $keterampilanpekerja->id ? 'selected' : ''); ?>>
                        <?php echo e($keterampilanpekerja->keterampilan); ?>
...
<tr>
    ...
    <td style="font-size: 12px; text-transform:uppercase; text-align:center;">
        <?php if($item->keterampilanpekerja && isset($item->keterampilanpekerja->keterampilan) && $item->keterampilanpekerja->keterampilan !== ''): ?>
            <?php echo e($item->keterampilanpekerja->keterampilan); ?>

            <?php $isDataAvailable = true; ?>
        <?php endif; ?>
    </td>

    <td style="font-size: 12px; text-transform:uppercase; text-align:left;">
        <?php if(isset($item->desa) && $item->desa !== ''): ?>
            <?php echo e($item->desa); ?>
    ...
    <td style="font-size: 12px; text-transform:uppercase; text-align:center;">
        <?php if($item->pengawasanlokasi && isset($item->pengawasanlokasi->kota) && $item->pengawasanlokasi->kota !== ''): ?>
            <?php echo e($item->pengawasanlokasi->kota); ?>
    ...
    <td style="font-size: 12px; text-transform:uppercase; text-align:left;">
        <?php if(isset($item->nama) && $item->nama !== ''): ?>
    ...
    <td>
        <div class="button-container">
            <a href="/tenagakerja/skaskt/<?php echo e($item->nama); ?>" class="iconhover" title="View">
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/01_skasktalldataketerampilan.blade.php ENDPATH**/ ?>