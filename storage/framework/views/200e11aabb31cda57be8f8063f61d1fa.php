...
<br>
        <div class="container-update" style="col-lg-12">
            <!-- Menampilkan pesan sukses jika ada -->
                ...
                <form action="/datapjtupdatestore/<?php echo e($data->id); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="pengawasanlokasi_id" name="pengawasanlokasi_id" required>
                            <?php $__currentLoopData = $datapengawasanlokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($lokasi->id); ?>" <?php echo e(old('pengawasanlokasi_id', $data->pengawasanlokasi_id) == $lokasi->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="number" class="form-control" id="nopjt" name="nopjt" value="<?php echo e(old('nopjt', $data->nopjt)); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="text" class="form-control" id="sfesifikasi" name="sfesifikasi" value="<?php echo e(old('sfesifikasi', $data->sfesifikasi)); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_terbit" name="tanggal_terbit" value="<?php echo e(old('tanggal_terbit', \Carbon\Carbon::parse($data->tanggal_terbit)->locale('id')->translatedFormat('d F Y'))); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="date" class="form-control" id="masa_berlaku" name="masa_berlaku" value="<?php echo e(old('masa_berlaku', \Carbon\Carbon::parse($data->masa_berlaku)->locale('id')->translatedFormat('d F Y'))); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <div class="preview-container">
                            <img id="foto_pjt-preview" src="<?php echo e(asset('storage/' . $data->foto_pjt)); ?>" alt="Preview" class="img-preview" style="max-width: 100px; margin-right: 10px;" />
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/02_pjt/update.blade.php ENDPATH**/ ?>