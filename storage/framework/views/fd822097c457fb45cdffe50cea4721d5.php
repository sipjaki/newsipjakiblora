...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('updatestore.renstra', $renstra->judul)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?> <!-- Gunakan metode PUT untuk update data -->
    
                <div class="form-group">
                    <label for="judul" style="text-align:left;"><i class="fas fa-file me-2" ></i> Judul Rencana Strategis  </label>
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $renstra->judul)); ?>" required>
                </div>
    
                <div class="form-group">
                    <label for="peraturan" style="text-align:left;"><i class="fas fa-file me-2" ></i> File Peraturan Undang-Undang</label>
                    <input type="file" id="peraturan" name="peraturan" value="<?php echo e(old('peraturan', $renstra->peraturan)); ?>">
                </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/01_struktur/02_renstra/update.blade.php ENDPATH**/ ?>