...
Pengawasan & Ketertiban Jasa Konstruksi  <br> Pemerintah Kabupaten Bandung Barat
</h2>
</div>
...
<table>
        ...
        $start = ($data->currentPage() - 1) * $data->perPage() + 1;
            ...
            <tr>
                ...
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->pengawasanlokasi->kota); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->pengawasanbangunangedung->bangunan); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->penanggungjawabteknis->nama_lengkap); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->pengawasanstatus->status); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->pengawasantindakan->tindakan); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($item->judul); ?></td>
                
                <td style="font-size: 12px; text-align:center; text-transform:uppercase">
                    <?php echo e(\Carbon\Carbon::parse($item->tanggal_laporan)->locale('id')->translatedFormat(' d F Y')); ?>

                </td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($item->keterangan); ?></td>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/03_datajakon/04_pengawasan.blade.php ENDPATH**/ ?>