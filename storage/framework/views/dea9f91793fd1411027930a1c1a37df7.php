...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-file mr-2"></i>Peraturan Walikota/Bupati Tentang Jasa Konstruksi </div></label>
        </a>
       
        <a href="/perwalikotabupati" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('peruud.updateperwalikotabupati', $perwalikotabupati->judul)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?> <!-- Gunakan metode PUT untuk update data -->
                <div class="form-group">
                    <label for="judul" style="text-align:left; font-size: 14px;">
                        <i class="fas fa-file-alt me-2"></i> Judul Peraturan Walikota/Bupati Tentang Jasa Konstruksi 
                    </label>
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $perwalikotabupati->judul)); ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="peraturan" style="text-align:left; font-size: 14px;">
                        <i class="fas fa-file-upload me-2"></i> File Peraturan Undang-Undang
                    </label>
                    <input type="file" id="peraturan" name="peraturan" value="<?php echo e(old('peraturan', $perwalikotabupati->peraturan)); ?>">
                </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/10_perwalikotabupati/update.blade.php ENDPATH**/ ?>