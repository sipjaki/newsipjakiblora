...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <button class="download-btn badgedownload" id="downloadBtn"><i class="fas fa-download mr-2"></i>Download PDF</button>
                ...
                <a href="/peruud/<?php echo e($items->judul); ?>" style="background: white;">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/01_undangundang/index.blade.php ENDPATH**/ ?>