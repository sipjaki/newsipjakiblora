...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-plus mr-2"></i>Create Peraturan Walikota/Bupati Tentang Jasa Konstruksi </div></label>
        </a>
        <a style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('peruud.createperwalikotabupati')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group d-flex align-items-center">
                    <label for="judul" class="mr-3" style="width: 200px; text-align:left; font-size: 14px;">
                        <i class="fas fa-file-alt mr-2"></i> Judul
                    </label>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/10_perwalikotabupati/create.blade.php ENDPATH**/ ?>