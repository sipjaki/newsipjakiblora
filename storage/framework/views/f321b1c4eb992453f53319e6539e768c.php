...
<div class="div">    
    <a href="/skkchart/register" style="background: white;">
        <button class="badgepencarian" style="border: none; font-size:12px; cursor:pointer; "><i class="fa fa-map-marker" style="margin-right: 5px;"></i>
            KECAMATAN <?php echo e($data_namakecamatan->nama_kecamatan); ?></button>
    </a>
    <a href="/giskbb">
...
<div class="container-kbb" style="margin-bottom:50px;">
    <img src="<?php echo e($data_namakecamatan->gambar); ?>" alt="" style="width: 400px; height:400px; border-radius:15px;">
</div>
    ...
    window.onload = function () {
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            data: [{
                ...
                indexLabel: "{name} - {y}%",
                dataPoints: [
                    { y: <?php echo e($persentase_laki_laki); ?>, name: "Laki-Laki", exploded: true },
                    { y: <?php echo e($persentase_perempuan); ?>, name: "Perempuan" }
                ]
            }]
        });
        chart.render();
...
<h6 style="color: black; font-size:20px;">
    <span style="font-size: 16px; margin-bottom:20px;">Keterangan Wilayah Kecamatan <?php echo e(ucwords(strtolower($data_namakecamatan->nama_kecamatan))); ?></span>
</h6>
<br>
<h6 style="text-align: justify">

    <?php echo $data_namakecamatan->keterangan_gis; ?>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/giskkbb/show.blade.php ENDPATH**/ ?>