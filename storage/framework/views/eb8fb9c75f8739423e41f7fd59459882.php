...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->telepon); ?></td>
                        
                        
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->qapertanyaan->pertanyaan); ?></td>
                    ...
                    .iconhover i {
                        ...
                        <div class="button-container">
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.qapertanyaan', $item->nama_lengkap)); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/qa/pertanyaan/index.blade.php ENDPATH**/ ?>