...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <!-- <div class="badge"><i class="fas fa-edit me-2"></i>Create New </div></label> -->
                        <button id="previewBtn" class="badge" style="border: none; font-size:15px; cursor:pointer "> <i class="fas fa-file" style="margin-right: 5px;"></i>Lanjutan Lampiran Bagian 1</button>
...
<style>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    .iconhover i {
                        ...
                        <div class="button-container">
                            <a href="/sbulampiran1/<?php echo e($item->judul); ?>" class="iconhover" title="Download">
            ...
            <div class="div">
                ...
                <a href="/standarbiayaumum" style="background: inherit">
                    <button class="badge-lampiran" style="border: none; font-size:15px; cursor:pointer "><i class="fas fa-file" style="margin-right: 5px;"></i> Standar Biaya Umum</button>
                </a>
            </div>
        </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/03_standarbiayaumum/lampiran1/index.blade.php ENDPATH**/ ?>