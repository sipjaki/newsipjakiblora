...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a href="/perpemerintah/<?php echo e($items->judul); ?>" style="background: white;">
...
.alert .closebtn:hover {
    ...
    <div class="pdf-container mt-4">
        <iframe class="pdf-frame" src="<?php echo e(asset('storage/' . $items->peraturan)); ?>"></iframe>
    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/02_pemerintah/index.blade.php ENDPATH**/ ?>