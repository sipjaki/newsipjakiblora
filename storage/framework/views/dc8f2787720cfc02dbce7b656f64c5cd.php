...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <!-- <div class="badge"><i class="fas fa-edit me-2"></i>Create New </div></label> -->
                        <button id="previewBtn" class="badge" style="border: none; font-size:15px; cursor:pointer "> <i class="fas fa-file" style="margin-right: 5px;"></i>Peraturan Walikota/Bupati Tentang Jasa Konstruksi</button>
                        <a href="/perwalikotabupaticreate" style="background: inherit">
...
<style>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    .iconhover i {
                        ...
                        <div class="button-container">
                            <a href="#" class="iconhover" title="View" onclick="window.location.href='<?php echo e(route('peruud.suratkeputusanshowbyjudul', $item->judul)); ?>'; return false;">
                                <i class="fas fa-eye"></i>
                            </a>
                                    <a href="/perwalikotabupati/update/<?php echo e($item->judul); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('peruud.deleteperwalikotabupati', $item->judul)); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/11_suratkeputusan/index.blade.php ENDPATH**/ ?>