...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a href="/pengawasandanketertiban/update/<?php echo e($data->judul); ?>" style="background: inherit;">
...
<br>
        <div class="container-update" style="col-lg-12">
            <!-- Menampilkan pesan sukses jika ada -->
             ...
             <div class="form-group d-flex align-items-center mt-3">
                ...
                <input type="text" class="form-control" id="pengawasanlokasi_id" name="pengawasanlokasi_id" value="<?php echo e(old('pengawasanlokasi_id', $data->pengawasanlokasi->kota)); ?>" required readonly>
            </div>
            
            <div class="form-group d-flex align-items-center mt-3">
                <label for="pengawasanbangunangedung_id" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                    <i class="fas fa-building me-2"></i> Status Bangunan
                </label>
                <input type="text" class="form-control" id="pengawasanbangunangedung_id" name="pengawasanbangunangedung_id" value="<?php echo e(old('pengawasanbangunangedung_id', $data->pengawasanbangunangedung->bangunan)); ?>" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="penanggungjawabteknis_id" name="penanggungjawabteknis_id" value="<?php echo e(old('penanggungjawabteknis_id', $data->penanggungjawabteknis->nama_lengkap)); ?>" required readonly>
            </div>
            
            <div class="form-group d-flex align-items-center mt-3">
                <label for="pengawasanstatus_id" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                    <i class="fas fa-check-circle me-2"></i> Pengawasan Status
                </label>
                <input style="text-transform: uppercase;" type="text" class="form-control" id="pengawasanstatus_id" name="pengawasanstatus_id" value="<?php echo e(old('pengawasanstatus_id', $data->pengawasanstatus->status)); ?>" required readonly>
            </div>
            
            <div class="form-group d-flex align-items-center mt-3">
                <label for="pengawasantindakan_id" class="mr-3" style="width: 200px; text-align:left; font-size:14px;">
                    <i class="fas fa-tasks me-2"></i> Pengawasan Tindakan
                </label>
                <input style="text-transform: uppercase;" type="text" class="form-control" id="pengawasantindakan_id" name="pengawasantindakan_id" value="<?php echo e(old('pengawasantindakan_id', $data->pengawasantindakan->tindakan)); ?>" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="judul" name="judul" value="<?php echo e(old('judul', $data->judul)); ?>" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="tanggal_laporan" name="tanggal_laporan" value="<?php echo e(old('tanggal_laporan', $data->tanggal_laporan)); ?>" required readonly>
            </div>
            ...
            <div class="form-group d-flex align-items-center mt-3">
                ...
                <input style="text-transform: uppercase;" type="text" class="form-control" id="keterangan" name="keterangan" value="<?php echo e(old('keterangan', $data->keterangan)); ?>" required readonly>
            </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/01_pengawasanketertiban/show.blade.php ENDPATH**/ ?>