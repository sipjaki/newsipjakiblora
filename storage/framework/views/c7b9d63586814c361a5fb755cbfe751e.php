...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('peruud.updatesuratedaran', $suratedaran->judul)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $suratedaran->judul)); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="peraturan" name="peraturan" value="<?php echo e(old('peraturan', $suratedaran->peraturan)); ?>">
                </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/06_suratedaran/update.blade.php ENDPATH**/ ?>