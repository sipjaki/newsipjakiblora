...
Peraturan Bupati/ Walikota Tentang Jasa Konstruksi
</h2>
</div>
...
<a>
<div class="badge"><i class="fas fa-file mr-2"></i>PERATURAN BUPATI/ WALIKOTA TENTANG JASA KONSTRUKSI</div></label>
</a>
<a>
<div class="badgehidden" style="color: white"></div></label>
</a>
<a href="/peraturan/walikotadanbupati" style="background: white;">
...
<div class="badge"><i class="fas fa-file mr-2"></i><?php echo e($data->judul); ?></div></label>
</a>
</div>
...
<div class="pdf-container">
    <iframe class="pdf-frame" src="<?php echo e(asset('storage/' . $data->peraturan)); ?>"></iframe>
</div>
...
document.getElementById('downloadBtn').addEventListener('click', function() {
    // URL file PDF
    const pdfUrl = '<?php echo e(asset('storage/' . $data->peraturan)); ?>';
    
    // Nama file yang diunduh berdasarkan atribut judul
    const fileName = '<?php echo e($data->judul); ?>' + '.pdf'; // Pastikan menambahkan ekstensi file yang sesuai
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/11_peraturan/10_peraturanwalikotashow.blade.php ENDPATH**/ ?>