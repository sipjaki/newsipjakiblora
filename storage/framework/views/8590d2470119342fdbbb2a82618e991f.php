...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-file mr-2"></i>Surat Keputusan Menteri Tentang Jasa Konstruksi </div></label>
        </a>
        <a style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('peruud.updateskmenteri', $skmenteri->judul)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?> <!-- Gunakan metode PUT untuk update data -->
    
                <div class="form-group">
                    <label for="judul" style="text-align:left;"><i class="fas fa-file me-2" ></i> Judul Surat Keputusan Menteri Tentang Jasa Konstruksi </label>
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $skmenteri->judul)); ?>" required>
                </div>
    
                <div class="form-group">
                    <label for="peraturan" style="text-align:left;"><i class="fas fa-file me-2" ></i> File Peraturan Undang-Undang</label>
                    <input type="file" id="peraturan" name="peraturan" value="<?php echo e(old('peraturan', $skmenteri->peraturan)); ?>">
                </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/05_skmenteri/update.blade.php ENDPATH**/ ?>