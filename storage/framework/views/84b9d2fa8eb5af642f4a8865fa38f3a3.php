...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('peruud.updatekeputusan', $keputusan->judul)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?> <!-- Gunakan metode PUT untuk update data -->
                <div class="form-group">
                    <label for="judul" style="text-align:left; font-size: 14px;">
                        <i class="fas fa-file-alt me-2"></i> Judul Surat Keputusan Tentang Jasa Konstruksi 
                    </label>
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $keputusan->judul)); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="peraturan" name="peraturan" value="<?php echo e(old('peraturan', $keputusan->peraturan)); ?>">
                </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/11_keputusan/update.blade.php ENDPATH**/ ?>