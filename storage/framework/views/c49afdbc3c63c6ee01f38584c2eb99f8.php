...
<form id="desa-form" method="GET" action="<?php echo e(url('/tenagakerja/desa')); ?>">
    <div class="custom-select-wrapper">
        <select name="id" id="kecamatan-dropdown" onchange="submitForm()">
            <option value="">PILIH DESA</option>
            <?php if($dataDesa && count($dataDesa) > 0): ?>
     ...
     <table>
        ...
        $start = ($data->currentPage() - 1) * $data->perPage() + 1;
            ...
            <tr>
                ...
                <td style="font-size: 12px; text-transform:uppercase; text-align:center;"><?php echo e($item->desa); ?></td>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/01_skasktalldatadesa.blade.php ENDPATH**/ ?>