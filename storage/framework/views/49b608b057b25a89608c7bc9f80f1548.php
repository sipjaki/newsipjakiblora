...
Asosiasi Pengusaha Jasa Konstruksi <br> Pemerintah Kabupaten Bandung Barat
</h2>
</div>
...
<table>
        ...
        $start = ($data->currentPage() - 1) * $data->perPage() + 1;
            ...
            <tr>
                ...
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->nama_asosiasi); ?></td>
                
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->provinsi); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->kontak); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->email); ?></td>
                
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->jumlah_anggota); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->status); ?></td>
            ...
            .iconhover i {
                ...
                <a href="/datajakon/asosiasi/<?php echo e($item->nama_asosiasi); ?>" class="iconhover" title="View">
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/03_datajakon/01_asosiasi.blade.php ENDPATH**/ ?>