...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->judul); ?></td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/standarbiayaumum/<?php echo e($item->judul); ?>" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                                <a href="/standarbiayaumum/update/<?php echo e($item->judul); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.standarbiayaumum', $item->judul)); ?>')">
            ...
            <div class="div">
                ...
                <a href="/sbulampiran3" style="background: inherit">
                    <button class="badge-lampiran" style="border: none; font-size:15px; cursor:pointer "><i class="fas fa-file" style="margin-right: 5px;"></i>Lampiran 3</button>
                </a>
                
                <a href="/sbulampiran2" style="background: inherit">
                    <button class="badge-lampiran" style="border: none; font-size:15px; cursor:pointer "><i class="fas fa-file" style="margin-right: 5px;"></i> Lampiran 2</button>
                </a>
                
                <a href="/sbulampiran1" style="background: inherit">
                    <button class="badge-lampiran" style="border: none; font-size:15px; cursor:pointer "><i class="fas fa-file" style="margin-right: 5px;"></i> Lampiran 1</button>
                </a>
            </div>
        </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/03_standarbiayaumum/index.blade.php ENDPATH**/ ?>