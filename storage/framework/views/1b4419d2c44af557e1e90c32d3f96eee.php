...
Agenda Sertifikasi Pekerja Konstruksi <br> Kabupaten Bandung Barat
</h2>
</div>
...
<table>
        ...
        $start = ($data->currentPage() - 1) * $data->perPage() + 1;
            ...
            <tr>
                ...
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($item->pengawasanlokasi->kota); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($item->statusprogram); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($item->nama_agenda); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($item->keterangan); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->kuota); ?> Orang</td>
                

                <td style="font-size: 12px; text-align:center; text-transform:uppercase">
                    <?php echo e(\Carbon\Carbon::parse($item->tanggal_mulai)->locale('id')->translatedFormat(' d F Y')); ?>

                </td>
                
                <td style="font-size: 12px; text-align:center; text-transform:uppercase">
                    <?php echo e(\Carbon\Carbon::parse($item->tanggal_selesai)->locale('id')->translatedFormat(' d F Y')); ?>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/02_berita/03_agendasertifikasi/index.blade.php ENDPATH**/ ?>