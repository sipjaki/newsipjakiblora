...
<div class="show-entries" style="border-radius: 10px;">
    <label for="entries" style="margin-right: 5px;">
        ...
        <!-- <div class="badge"><i class="fas fa-edit me-2"></i>Create New </div></label> -->
                        ...
                        <a href="/newtenagakerjacreate" style="background: inherit">
                            <button class="badge-create" style="border: none; font-size:15px; cursor:pointer "><i class="fas fa-edit" style="margin-right: 5px;"></i>Create New</button>
                        </a>
...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-transform: uppercase; text-align:left"><?php echo e($item->keterampilanpekerja->keterampilan); ?></td>
                        <td style="font-size: 12px; text-transform: uppercase;"><?php echo e($item->tahunpilihan->tahun); ?></td>
                    ...
                    .iconhover i {
                        ...
                        <a href="<?php echo e(route('skktenagakerja.show', $item->nama)); ?>" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                                <a href="/newtenagakerja/update/<?php echo e($item->nama); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>
                          

                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.tenagakerja', $item->nama)); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/01_skk/index.blade.php ENDPATH**/ ?>