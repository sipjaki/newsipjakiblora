...
<style>
             ...
             <table>
                <thead>
                    <tr>
                        ...
                        <th style="width:150px;; font-size:12px;">STATUS ADMIN</th>
                        <th style="width:150px; font-size:12px;">NAMA</th>
                        <th style="width:100px; font-size:12px;">USERNAME</th>
                ...
                $start = ($datauser->currentPage() - 1) * $datauser->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->statusadmin->status); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->name); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->username); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->phone_number); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->email); ?></td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/administrator/<?php echo e($item->name); ?>" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                                <a href="/administrator/update/<?php echo e($item->name); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('administrator.deleteadministrator', $item->name)); ?>')">
        ...
        <div class="pagination-container" style="margin-top: 75px; margin-bottom:75px; display: flex; flex-direction: column; align-items: center;">
                <div class="pagination-info mb-2" style="margin-bottom: 10px; color:orange; font-weight: 500;">
                    Data Ke <?php echo e($datauser->firstItem()); ?> Sampai <?php echo e($datauser->lastItem()); ?> Dari <?php echo e($datauser->total()); ?> Jumlah <?php echo e($title); ?>

                </div>
                    <ul class="pagination" style="display: flex; padding-left: 0; list-style: none;">
                        <li class="page-item <?php echo e($datauser->onFirstPage() ? 'disabled' : ''); ?>" style="margin-right: 5px;">
                            <a class="page-link" href="<?php echo e($datauser->previousPageUrl()); ?>" style="position: relative; display: block; padding: 0.5rem 0.75rem; margin-left: -1px; line-height: 1.25; color: white; background-color: #fff; border: 1px solid #dee2e6; font-size:12px; border-radius: 20px 0px 0px 20px;"><i class="fas fa-arrow-left" style="margin-right:10px;"></i>Previous</a>
                        </li>

                        <?php $__currentLoopData = $datauser->getUrlRange($datauser->currentPage() - 0, $datauser->currentPage() + 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="page-item <?php echo e($page == $datauser->currentPage() ? 'active' : ''); ?>" style="margin-right: 5px;">
                        ...
                        <li class="page-item <?php echo e($datauser->hasMorePages() ? '' : 'disabled'); ?>" style="margin-right: 5px;">
                            <a class="page-link" href="<?php echo e($datauser->nextPageUrl()); ?>" style="position: relative; display: block; padding: 0.5rem 0.75rem; margin-left: -1px; line-height: 1.25; color: white; background-color: #fff; border: 1px solid #dee2e6; font-size:12px; border-radius: 0px 20px 20px 0px;">Next <i class="fas fa-arrow-right" style="margin-left:10px;"></i></a>
                        </li>
                    </ul>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/15_administrator/user/index.blade.php ENDPATH**/ ?>