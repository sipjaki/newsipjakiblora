...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->pengawasanlokasi->kota); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->pengawasanbangunangedung->bangunan); ?></td>
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase;"><?php echo e($item->penanggungjawabteknis->nama_lengkap); ?></td>
                        <style>
                            .btn-full-width {
                                    width: 100%;
                                    text-align: center;
                        ...
                        <td style="font-size: 12px; text-align:left;">
                            ...
                            <button class="btn btn-full-width <?php echo e($class); ?>">
                                <?php echo e($status); ?>
                        ...
                        <td style="font-size: 12px; text-align:center;">
                            <?php echo e(\Carbon\Carbon::parse($item->tanggal_laporan)->locale('id')->translatedFormat('l, d F Y')); ?>
                    ...
                    .iconhover i {
                        ...
                        <a href="/pengawasandanketertiban/<?php echo e($item->judul); ?>" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                                <a href="/pengawasandanketertiban/update/<?php echo e($item->judul); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.pengawasandanketertiban', $item->id)); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/01_pengawasanketertiban/index.blade.php ENDPATH**/ ?>