...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a href="/keputusan" style="background: white;">
            <button class="badgekembali" style="border: none; font-size:12px; cursor:pointer; "> <i class="fa fa-arrow-circle-left mr-2" style="margin-right: 5px;"></i>Kembali</button>
        </a>
        
        <button class="download-btn badgedownload" id="downloadBtn"><i class="fas fa-download mr-2"></i>Download PDF</button>
        
        <a href="/keputusan/update/<?php echo e($data->judul); ?>" style="background: white;">
...
.pdf-frame {
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/11_keputusan/show.blade.php ENDPATH**/ ?>