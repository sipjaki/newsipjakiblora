...
<br>
            ...
            <form action="<?php echo e(route('updatestore.datapjt', $data->nama_lengkap)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="form-group-inner">
                        ...
                        <select style="width:690px;" id="statusadmin" name="statusadmin" required>
                            <?php $__currentLoopData = $datalistadmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($status->id); ?>" 
                                    <?php echo e($status->id == $datauser->statusadmin_id ? 'selected' : ''); ?>>
                ...
                <div class="form-group">
                    <div class="form-group-inner">
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e(old('name', $datauser->name)); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group-inner">
                        ...
                        <input type="text" id="username" name="username" value="<?php echo e(old('username', $datauser->username)); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group-inner">
                        ...
                        <input type="number" id="phone_number" name="phone_number" value="<?php echo e(old('phone_number', $datauser->phone_number)); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group-inner">
                        ...
                        <input type="text" id="email" name="email" value="<?php echo e(old('email', $datauser->email)); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group-inner">
                        ...
                        <div class="preview-container">
                            <img id="avatar-preview" src="<?php echo e(asset('storage/' . $datauser->avatar)); ?>" alt="Preview" class="img-preview" />
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/15_administrator/user/update.blade.php ENDPATH**/ ?>