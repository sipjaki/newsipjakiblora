...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="/acarapelatihancreatestore" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <select class="form-control" id="kegiatanjaskon_id" name="kegiatanjaskon_id" required>
                        ...
                        <?php $__currentLoopData = $datakegiatanjaskon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->judul_kegiatan); ?></option>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input type="hidden" class="form-control" id="user_id" name="user_id" value="<?php echo e(Auth::user()->id); ?>" required readonly>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/04_acarapelatihan/create.blade.php ENDPATH**/ ?>