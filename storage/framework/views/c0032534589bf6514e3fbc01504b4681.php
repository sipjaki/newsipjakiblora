                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->judul))); ?>
                    ...
                    <tr>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: justify; font-weight: 700; color: black;">
                            <span id="shortText"><?php echo e(strlen($data->keterangan) > 500 ? substr($data->keterangan, 0, 500) . '...' : $data->keterangan); ?></span>
                            <span id="fullText" style="display: none;"><?php echo e($data->keterangan); ?></span>
                            <?php if(strlen($data->keterangan) > 500): ?>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->tanggal))); ?>
...
<?php echo $__env->make('backend.00_dashboard.part.menufooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/01_berita/show.blade.php ENDPATH**/ ?>