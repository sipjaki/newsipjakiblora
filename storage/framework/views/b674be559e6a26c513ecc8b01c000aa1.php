...
<br>
                ...
                <form action="/timpembinaupdatestore/<?php echo e($data->nama_lengkap); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <div class="preview-container">
                            <img id="fototimpembina-preview" src="<?php echo e(asset('storage/' . $data->fototimpembina)); ?>" alt="Preview" class="img-preview" style="max-width: 100px; margin-right: 10px;" />
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/03_timpembina/update.blade.php ENDPATH**/ ?>