...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-file mr-2"></i>Rencana Strategis Pemerintah Kabupaten Bandung Barat </div></label>
        </a>
        <a style="background: white;">
            <div class="badgehidden" style="color: white"><i class="fas fa-file mr-2"></i>........ ........ ........ ........ ........ ........</div></label>
        </a>
     
        <a href="/tupoksi" style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('updatestore.tupoksi', $tupoksi->judul)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?> <!-- Gunakan metode PUT untuk update data -->
    
                <div class="form-group">
                    <label for="judul" style="text-align:left;"><i class="fas fa-file me-2" ></i> Judul Tupoksi Program Jasa Konstruksi  </label>
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $tupoksi->judul)); ?>" required>
                </div>
    
                <div class="form-group">
                    <label for="peraturan" style="text-align:left;"><i class="fas fa-file me-2" ></i> File Peraturan Undang-Undang</label>
                    <input type="file" id="peraturan" name="peraturan" value="<?php echo e(old('peraturan', $tupoksi->peraturan)); ?>">
                </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/01_struktur/03_tupoksi/update.blade.php ENDPATH**/ ?>