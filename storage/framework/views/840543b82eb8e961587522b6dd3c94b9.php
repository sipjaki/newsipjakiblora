...
<style>
 ...
 <table id="datakeluar" style="width: 100%; border-collapse: collapse;">
    ...
    <tbody>
        ...
        <div id="dataContainer" data-nama="<?php echo e($data->name); ?>" style="display: none;"></div>

        <tr>
            <td style="width: 150px; padding: 10px; vertical-align: top;">
                <!-- Debug URL Gambar -->
                
                <img src="<?php echo e(asset('storage/' . $data->avatar)); ?>" alt="<?php echo e(asset('storage/' . $data->avatar)); ?>" style="width: 100%; min-width: 280px; height: auto; border-radius: 8px;">

                <p style="margin-top:10px;">Foto Administrator</p>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->name))); ?>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->statusadmin->status))); ?>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->username))); ?>
                    ...
                    <tr>
                        ...
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">No Telepon</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                    ...
                    <tr>
                        <td colspan="4" style="background-color: white; text-align: right; padding: 10px;">
                            Administrator Sipjaki | Sistem Informasi Pembina Jasa Konstruksi Kabupaten Bandung Barat | sipjakikbb.com
...
<?php echo $__env->make('backend.00_dashboard.part.menufooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/15_administrator/user/show.blade.php ENDPATH**/ ?>