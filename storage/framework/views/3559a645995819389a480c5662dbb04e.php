...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase"><?php echo e($item->jabatandalamkedinasan); ?></td>
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase"><?php echo e($item->nama_lengkap); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->email); ?></td>
                        
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase"><?php echo e($item->telepon); ?></td>
                        
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase">
                            <img style="width: 80%;" src="<?php echo e(asset('storage/' . $item->fototimpembina)); ?>" alt="">
                        </td>
                    ...
                    .iconhover i {
                        ...
                        <div class="button-container">
                                ...
                                <a href="/timpembina/update/<?php echo e($item->nama_lengkap); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.timpembina', $item->nama_lengkap)); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/03_timpembina/index.blade.php ENDPATH**/ ?>