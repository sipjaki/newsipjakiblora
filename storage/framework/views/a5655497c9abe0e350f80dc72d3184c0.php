...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white; margin-right:100px;" >
            <div class="badge"><i class="fas fa-file mr-2"></i>Standar Biaya Lanjutan Lampiran 3</div></label>
        </a>
        <a style="background: white;">
            <div class="badgehidden" style="color: white"><i class="fas fa-file mr-2"></i></div></label>
        </a>
        <a href="/sbulampiran3" style="background: white;">
...
<div style="margin-top: 15px;">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/03_standarbiayaumum/lampiran3/show.blade.php ENDPATH**/ ?>