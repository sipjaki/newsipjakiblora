...
<style>
 ...
 <table id="datakeluar" style="width: 100%; border-collapse: collapse;">
    <thead>
        <tr>
            <th colspan="2" style="background-color: #FFCB0F; text-align: center; font-size: 16px;">Data Penanggung Jawab Teknis | Pemerintah Kabupaten Bandung Barat</th>
        </tr>
    </thead>
    <tbody>
        <!-- Menyimpan nama data dalam elemen data -->
        <div id="dataContainer" data-nama="<?php echo e($data->instansi); ?>" style="display: none;"></div>

        <tr>
            <td style="width: 150px; padding: 10px; vertical-align: top;">
                <!-- Debug URL Gambar -->
                
                <?php if(Storage::disk('public')->exists($data->foto_pjt)): ?>
                <img src="<?php echo e(asset('storage/' . $data->foto_pjt)); ?>" alt="<?php echo e($data->foto_pjt); ?>" style="width: 100%; min-width: 280px; height: auto; border-radius: 8px;">
            <?php else: ?>
                <img src="<?php echo e($data->foto_pekerjaan); ?>" alt="<?php echo e($data->foto_pekerjaan); ?>" style="width: 100%; min-width: 280px; height: auto; border-radius: 8px;">
            <?php endif; ?>
                            <p style="margin-top:10px;">Foto Penanggung Jawab Teknis </p>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->nama_lengkap))); ?>
                    ...
                    <tr>
                        ...
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">No PJT</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->nopjt))); ?>
                    ...
                    <tr>
                        ...
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">Spesifikasi</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->sfesifikasi))); ?>
                    ...
                    <tr>
                        ...
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">Tanggal Terbit</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(\Carbon\Carbon::parse($data->tanggal_terbit)->locale('id')->translatedFormat('d F Y')); ?>
                    ...
                    <tr>
                        ...
                        <th style="background-color: #FFCB0F; width: 225px; text-align: left; font-size: 14px;">Masa Berlaku</th>
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(\Carbon\Carbon::parse($data->masa_berlaku)->locale('id')->translatedFormat('d F Y')); ?>
                    ...
                    <tr>
                        <td colspan="4" style="background-color: white; text-align: right; padding: 10px;">
                            Penanggung Jawab Teknis | Sistem Informasi Pembina Jasa Konstruksi Kabupaten Bandung Barat | sipjakikbb.com
...
<script>
    ...
    const formattedNama = nama ? nama.replace(/[^a-zA-Z0-9]/g, '_') : '<?php echo e($data->nama_lengkap); ?>';
...
<?php echo $__env->make('backend.00_dashboard.part.menufooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/02_pjt/show.blade.php ENDPATH**/ ?>