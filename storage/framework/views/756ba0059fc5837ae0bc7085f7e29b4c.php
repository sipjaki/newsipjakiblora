...
<script>
    window.onload = function () {
        ...
        var chart1 = new CanvasJS.Chart("chartContainer", {
            ...
            title: {
                text: "<?php echo e($judulstatistika); ?>",
                fontFamily: "Roboto",
                fontSize: 15
            },
            legend: {
            ...
            data: [{
                ...
                indexLabel: "{name} - {y}%",
                dataPoints: <?php echo json_encode($data_keterampilan); ?> // Update dataPoints
            }]
        });
        chart1.render();
        ...
        var chart2 = new CanvasJS.Chart("kecamatanchartContainer", {
            ...
            data: [{
                ...
                dataPoints: <?php echo json_encode($data_kecamatan); ?> // Update dataPoints
            }]
        });
        chart2.render();
        ...
        var chart3 = new CanvasJS.Chart("desachartContainer", {
            ...
            data: [{
                ...
                dataPoints: <?php echo json_encode($data_desa); ?> // Update dataPoints
            }]
        });
        chart3.render();
        ...
        var chart4 = new CanvasJS.Chart("bimtekchartContainer", {
            ...
            animationEnabled: true,
            title: {
                text: "<?php echo e($judultahunbimtek); ?>",
                fontFamily: "Roboto",
                fontSize: 15
            },
            legend: {
            ...
            data: [{
                ...
                toolTipContent: "{name}: <strong>{y}%</strong>",
                indexLabel: "{name} - {y}%",
                dataPoints: <?php echo json_encode($data_tahun_bimtek); ?> // Update dataPoints
            }]
        });
        chart4.render();
    };
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/statistika/index.blade.php ENDPATH**/ ?>