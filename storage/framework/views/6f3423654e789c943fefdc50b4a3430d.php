    ...
    <tbody>
        ...
        <tr>
            <td style="width: 150px; padding: 10px; vertical-align: top;">
                ...
                <img src="<?php echo e(asset('storage/' . $data->foto)); ?>" alt="<?php echo e(asset('storage/' . $data->foto)); ?>" style="width: 100%; min-width: 280px; height: auto; border-radius: 8px;">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->nama))); ?>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #FFCB0F; width: 20px;">:</td>
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->keterampilanpekerja->keterampilan))); ?>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #FFCB0F; width: 20px;">:</td>
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->tahunpilihan->tahun))); ?>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #FFCB0F; width: 20px;">:</td>
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->desa))); ?>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #FFCB0F; width: 20px;">:</td>
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->alamat))); ?>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #FFCB0F; width: 20px;">:</td>
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->nik))); ?>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #FFCB0F; width: 20px;">:</td>
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->kualifikasi))); ?>
                        ...
                        <tr>
                            ...
                            <td style="background-color: #FFCB0F; width: 20px;">:</td>
                            <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                <?php echo e(ucwords(strtolower($data->registrasi))); ?>
...
<div style="text-align: right; margin-top: 20px;">
    ...
    <script>
        document.getElementById('sktgatensiBtn').addEventListener('click', function() {
            // URL file PDF
            const pdfUrl = '<?php echo e(asset('storage/' . $data->kta_gatensi)); ?>';
            
            // Nama file yang diunduh berdasarkan atribut judul
            const fileName = 'KTA GATENSI JABAR |  '+'<?php echo e($data->nama); ?>' + '.pdf'; // Pastikan menambahkan ekstensi file yang sesuai
        ...
        <script>
            document.getElementById('skksertifikatBtn').addEventListener('click', function() {
                // URL file PDF
                const pdfUrl = '<?php echo e(asset('storage/' . $data->skk_pekerja)); ?>';
                
                // Nama file yang diunduh berdasarkan atribut judul
                const fileName = 'SKK SERTIFIKAT PEKERJA | '+'<?php echo e($data->nama); ?>' + '.pdf'; // Pastikan menambahkan ekstensi file yang sesuai
...
<?php echo $__env->make('backend.00_dashboard.part.menufooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/01_skk/show.blade.php ENDPATH**/ ?>