...
<style>
 ...
 <table id="datakeluar" style="width: 100%; border-collapse: collapse;">
    ...
    <tbody>
        ...
        <div id="dataContainer" data-nama="<?php echo e($data->judul_kegiatan); ?>" style="display: none;"></div>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->judul_kegiatan))); ?>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->pengawasanlokasi->kota))); ?>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #FFCB0F; width: 20px;">:</td>
                        <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                            <?php echo e(ucwords(strtolower($data->alamat_kegiatan))); ?>
...
<div class="container-galeryfoto">
    ...
    <div class="card-grid">
        ...
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita1)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita2)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita3)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita4)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita5)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita6)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita7)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita8)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita9)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita10)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita11)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita12)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita13)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita14)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita15)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita16)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita17)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita18)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita19)); ?>" alt="Image" class="card-image">
            </div>
        
        <div class="card">
                <img src="<?php echo e(asset('storage/'.  $data->berita20)); ?>" alt="Image" class="card-image">
            </div>
...
<?php echo $__env->make('backend.00_dashboard.part.menufooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/03_dokumentasipelatihan/show.blade.php ENDPATH**/ ?>