            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <img class="img-fluid w-100" src="<?php echo e(asset('storage/' .  $data->gambar)); ?>" style="object-fit: cover; cursor: pointer;" data-toggle="modal" data-target="#imageModal">
                        ...
                        <div class="bg-white border border-top-0 p-3">
                            ...
                            <div class="owl-carousel main-carousel d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                <a href="/portalberita/<?php echo e($item->judul); ?>">
                                    <img src="<?php echo e(asset('storage/' . $item->gambar)); ?>" style="width:50%; cursor:pointer" alt="">
                                </a>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/02_berita/01_portalberita/showindex.blade.php ENDPATH**/ ?>