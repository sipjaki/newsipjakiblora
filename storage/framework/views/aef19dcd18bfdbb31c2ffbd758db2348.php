...
@media (min-width: 768px) {
    ...
    .badgehidden {
        ...
        <a style="background: white;">
            <div class="badge"><i class="fas fa-file mr-2"></i>Update Data Asosiasi Pengusaha </div></label>
        </a>
        <a style="background: white;">
...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('updatestore.newasosiasipengusaha', $dataasosiasipengusaha->nama_asosiasi)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" id="nama_asosiasi" name="nama_asosiasi" class="form-control" value="<?php echo e(old('nama_asosiasi', $dataasosiasipengusaha->nama_asosiasi)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" id="alamat_kantor" name="alamat_kantor" class="form-control" value="<?php echo e(old('alamat_kantor', $dataasosiasipengusaha->alamat_kantor)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" id="pengawasanlokasi_id" name="pengawasanlokasi_id" class="form-control" value="<?php echo e(old('pengawasanlokasi_id', $dataasosiasipengusaha->pengawasanlokasi->kota)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" id="provinsi" name="provinsi" class="form-control" value="<?php echo e(old('provinsi', $dataasosiasipengusaha->provinsi)); ?>" required readonly>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="number" id="kontak" name="kontak" class="form-control" value="<?php echo e(old('kontak', $dataasosiasipengusaha->kontak)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input  type="text" id="email" name="email" class="form-control" value="<?php echo e(old('email', $dataasosiasipengusaha->email)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input type="text" id="website" name="website" class="form-control" value="<?php echo e(old('website', $dataasosiasipengusaha->website)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="text" id="kepala_asosiasi" name="kepala_asosiasi" class="form-control" value="<?php echo e(old('kepala_asosiasi', $dataasosiasipengusaha->kepala_asosiasi)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input style="text-transform: uppercase;" type="number" id="jumlah_anggota" name="jumlah_anggota" class="form-control" value="<?php echo e(old('jumlah_anggota', $dataasosiasipengusaha->jumlah_anggota)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <select id="status" name="status" required class="form-control">
                        <option value="" disabled <?php echo e(old('status', $dataasosiasipengusaha->status) == '' ? 'selected' : ''); ?>>PILIH STATUS</option>
                        <option value="AKTIF" <?php echo e($dataasosiasipengusaha->status == 'AKTIF' ? 'selected' : ''); ?>>AKTIF</option>
                        <option value="TIDAK AKTIF" <?php echo e($dataasosiasipengusaha->status == 'TIDAK AKTIF' ? 'selected' : ''); ?>>TIDAK AKTIF</option>
                    </select>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <div class="preview-container">
                        <img id="foto_asosiasi-preview" src="<?php echo e(asset('storage/' . $dataasosiasipengusaha->foto_asosiasi)); ?>" alt="Preview" class="img-preview" style="max-width: 100px; margin-right: 10px;" />
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/02_asosiasipengusaha/update.blade.php ENDPATH**/ ?>