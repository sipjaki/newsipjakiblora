                        ...
                        <div class="bg-white border border-top-0 p-3">
                            ...
                            <div class="scroll-container">
                                <div class="scrolling-content">
                                    <img src="<?php echo e($item->berita1); ?>" alt="<?php echo e($item->berita1); ?>">
                                    <img src="<?php echo e($item->berita3); ?>" alt="<?php echo e($item->berita3); ?>">
                                    <img src="<?php echo e($item->berita4); ?>" alt="<?php echo e($item->berita4); ?>">
                                    <img src="<?php echo e($item->berita6); ?>" alt="<?php echo e($item->berita6); ?>">
                                    <img src="<?php echo e($item->berita7); ?>" alt="<?php echo e($item->berita7); ?>">
                                    <img src="<?php echo e($item->berita9); ?>" alt="<?php echo e($item->berita9); ?>">
                                    <img src="<?php echo e($item->berita18); ?>" alt="<?php echo e($item->berita18); ?>">
                                    <img src="<?php echo e($item->berita19); ?>" alt="<?php echo e($item->berita19); ?>">
                                    <img src="<?php echo e($item->berita20); ?>" alt="<?php echo e($item->berita20); ?>">       
                                    <img src="<?php echo e($item->berita2); ?>" alt="<?php echo e($item->berita2); ?>">
                                    <img src="<?php echo e($item->berita5); ?>" alt="<?php echo e($item->berita5); ?>">
                                    <img src="<?php echo e($item->berita8); ?>" alt="<?php echo e($item->berita8); ?>">
                                    <img src="<?php echo e($item->berita10); ?>" alt="<?php echo e($item->berita10); ?>">
                                    <img src="<?php echo e($item->berita11); ?>" alt="<?php echo e($item->berita11); ?>">
                                    <img src="<?php echo e($item->berita12); ?>" alt="<?php echo e($item->berita12); ?>">
                                    <img src="<?php echo e($item->berita13); ?>" alt="<?php echo e($item->berita13); ?>">
                                    <img src="<?php echo e($item->berita14); ?>" alt="<?php echo e($item->berita14); ?>">
                                    <img src="<?php echo e($item->berita15); ?>" alt="<?php echo e($item->berita15); ?>">
                                    <img src="<?php echo e($item->berita16); ?>" alt="<?php echo e($item->berita16); ?>">
                                    <img src="<?php echo e($item->berita17); ?>" alt="<?php echo e($item->berita17); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/02_berita/03_sertifikasi/index.blade.php ENDPATH**/ ?>