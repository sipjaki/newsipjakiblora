...
<form id="perusahaan-form" method="GET" action="<?php echo e(url('/iujk/bidangusaha')); ?>">
    <div class="custom-select-wrapper" style="margin-left: 300px; width:350px;">
        <select name="judul" id="kecamatan-dropdown" onchange="submitForm()">
            ...
            <?php $__currentLoopData = $data_uijk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($item->klasifikasi_bidang_usaha); ?>"><?php echo e($item->klasifikasi_bidang_usaha); ?></option>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/08_iujk/uijkbidangusaha.blade.php ENDPATH**/ ?>