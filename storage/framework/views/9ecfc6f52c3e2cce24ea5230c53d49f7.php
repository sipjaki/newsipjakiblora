    ...
    <label for="entries" style="margin-right: 5px;">
        ...
        <a href="/settingkecamatan" style="background: inherit">
            <button class="badge" style="border: none; font-size: 14px; cursor: pointer;">
                <i class="fas fa-map-signs" style="margin-right: 5px;"></i> Kecamatan/Kota
            </button>
        </a>
...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase;" ><?php echo e($item->nama_asosiasi); ?></td>
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase;"><?php echo e($item->alamat_kantor); ?></td>
                        <td style="font-size: 12px; text-align:left; text-transform:uppercase;"><?php echo e($item->pengawasanlokasi->kota); ?></td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/asosiasipengusaha/<?php echo e($item->nama_asosiasi); ?>" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                                <a href="/asosiasipengusaha/update/<?php echo e($item->nama_asosiasi); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.asosiasipengusaha', $item->nama_asosiasi)); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/02_asosiasipengusaha/index.blade.php ENDPATH**/ ?>