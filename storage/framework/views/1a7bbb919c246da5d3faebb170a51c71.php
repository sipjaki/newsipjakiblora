...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->user->username); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->judul_kegiatan); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->alamat_kegiatan); ?></td>
                        <td style="font-size: 12px; text-align:center;">
                            <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d', $item->tanggal)->locale('id')->translatedFormat('d F Y')); ?>

                        </td>
                        
                        <td style="font-size: 12px; text-align:center;">
                        <a href="/dokumentasipelatihan/<?php echo e($item->judul_kegiatan); ?>" class="badge-selesai">GALERY</a>
                        </td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/dokumentasipelatihan/update/<?php echo e($item->judul_kegiatan); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('/dokumentasipelatihan/<?php echo e($item->id); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/03_dokumentasipelatihan/index.blade.php ENDPATH**/ ?>