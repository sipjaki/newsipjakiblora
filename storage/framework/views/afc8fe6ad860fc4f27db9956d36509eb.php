...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="<?php echo e(route('peruud.updateperpemerintah', $perpemerintah->judul)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="judul" name="judul" value="<?php echo e(old('judul', $perpemerintah->judul)); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="peraturan" name="peraturan" value="<?php echo e(old('peraturan', $perpemerintah->peraturan)); ?>">
                </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/14_peraturan/02_pemerintah/update.blade.php ENDPATH**/ ?>