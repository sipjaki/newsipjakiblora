...
<form id="bimtek-form" method="GET" action="<?php echo e(url('/tenagakerja/bimtek')); ?>">
    <div class="custom-select-wrapper">
        <select name="id" id="kecamatan-dropdown" onchange="submitForm()">
            <option value="">PILIH TAHUN BIMTEK</option>
            <?php if($datatahunpilihan && count($datatahunpilihan) > 0): ?>
...
<tr>
    ...
    <td style="font-size: 12px; text-transform:uppercase; text-align:center;"><?php echo e($item->tahunpilihan->tahun); ?></td>
    <td style="font-size: 12px; text-transform:uppercase; text-align:center;"><?php echo e($item->kualifikasi); ?></td>
    <td style="font-size: 12px; text-transform:uppercase; text-align:center;"><?php echo e($item->registrasi); ?></td>
    <td style="font-size: 12px; text-transform:uppercase; text-align:left;"><?php echo e($item->nama); ?></td>
    <td style="font-size: 12px; text-transform:uppercase; text-align:center;"><?php echo e($item->keterampilanpekerja->keterampilan); ?></td>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/01_skasktalldataregister.blade.php ENDPATH**/ ?>