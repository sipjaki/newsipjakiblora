...
<button id="previewBtn" class="badge" style="border: none; font-size:15px; cursor:pointer;">
    <i class="fas fa-calendar-alt" style="margin-right: 5px;"></i> Daftar Agenda Sertifikasi
</button>
...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->nama_agenda); ?></td>
                        <td style="font-size: 12px; text-align:left;"><?php echo e($item->keterangan); ?></td>
                        <td style="font-size: 12px; text-align: left;">
                            <span class="badge-kuota badge-primary w-100 text-center"><?php echo e($item->kuota); ?></span>
                        </td>
                        
                        <td style="font-size: 12px; text-align: left;">
                            <span class="badge-mulai badge-primary w-100 text-center"><?php echo e($item->tanggal_mulai); ?></span>
                        </td>
                        
                        <td style="font-size: 12px; text-align: left;">
                            <span class="badge-selesai badge-primary w-100 text-center"><?php echo e($item->tanggal_selesai); ?></span>
                        </td>
                        
                        <td style="font-size: 12px; text-align:center;"><?php echo e($item->pengawasanlokasi->kota); ?></td>
                        ...
                        <style>
                            .status-button {
                                border: none;
                                padding: 5px 5px;
                                border-radius: 5px; /* Radius border yang konsisten */
                                color: white;
                                font-size: 9px;
                        ...
                        <td style="font-size: 12px; text-align: center; text-transform: uppercase;">
                            <?php if($item->statusprogram === 'SEGERA HADIR'): ?>
                                <button class="status-button status-segera-hadir">
                                    SEGERA HADIR
                                </button>
                            <?php elseif($item->statusprogram === 'SELESAI'): ?>
                                <button class="status-button status-selesai">
                                    SELESAI
                                </button>
                            <?php elseif($item->statusprogram === 'BERJALAN'): ?>
                            <button class="status-button status-berjalan">
                                BERJALAN
                            </button>
                            <?php else: ?>
                                <button class="status-button status-di-batalkan">
                                    DI BATALKAN
                                </button>
                                <?php endif; ?>
                            </td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/beritaagenda/update/<?php echo e($item->nama_agenda); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('/beritaagenda/<?php echo e($item->id); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/02_agendasertifikasi/index.blade.php ENDPATH**/ ?>