...
<style>
             ...
             <table>
                ...
                $start = ($data->currentPage() - 1) * $data->perPage() + 1;
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase"><?php echo e($item->pengawasanlokasi->kota); ?></td>
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase"><?php echo e($item->nopjt); ?></td>
                        <td style="font-size: 12px; text-align:center; text-transform:uppercase"><?php echo e($item->sfesifikasi); ?></td>
                    ...
                    .iconhover i {
                        ...
                        <a href="/datapjt/<?php echo e($item->nama_lengkap); ?>" class="iconhover" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
                                <a href="/datapjt/update/<?php echo e($item->nama_lengkap); ?>" class="iconhover" title="Update">
                                    <i class="fas fa-edit"></i>
                                </a>


                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.datapjt', $item->nama_lengkap)); ?>')">
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/02_pjt/index.blade.php ENDPATH**/ ?>