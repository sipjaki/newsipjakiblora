                ...
                <div class="owl-carousel main-carousel position-relative">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                        <a href="/portalberita/<?php echo e($item->judul); ?>">
                            <img class="img-fluid h-100" src="<?php echo e($item->gambar); ?>" style="object-fit: cover;">
                        </a>
                        <div class="overlay">
                            <div class="mb-2">
                        ...
                        <div class="col-md-6 px-0">
                            <a href="/portalberita/<?php echo e($item->judul); ?>">
                                ...
                                <div class="position-relative overflow-hidden" style="height: 250px;">
                                    <img class="img-fluid w-100 h-100" src="<?php echo e($item->gambar); ?>" style="object-fit: cover;">
                                    <div class="overlay">
                                    <div class="mb-2">
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/02_berita/portalberita/navbarberita.blade.php ENDPATH**/ ?>