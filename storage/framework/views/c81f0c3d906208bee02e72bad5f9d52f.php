...
<br>
                ...
                <form action="<?php echo e(route('update.beritaagenda', $beritaagenda->nama_agenda)); ?>" method="POST">
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="statusprogram" name="statusprogram" required>
                            ...
                            <option value="BERJALAN" <?php echo e(old('statusprogram', $beritaagenda->statusprogram) == 'BERJALAN' ? 'selected' : ''); ?>>BERJALAN</option>
                            <option value="SEGERA HADIR" <?php echo e(old('statusprogram', $beritaagenda->statusprogram) == 'SEGERA HADIR' ? 'selected' : ''); ?>>SEGERA HADIR</option>
                            <option value="DIBATALKAN" <?php echo e(old('statusprogram', $beritaagenda->statusprogram) == 'DIBATALKAN' ? 'selected' : ''); ?>>DIBATALKAN</option>
                            <option value="SELESAI" <?php echo e(old('statusprogram', $beritaagenda->statusprogram) == 'SELESAI' ? 'selected' : ''); ?>>SELESAI</option>
                        </select>
                    </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/02_agendasertifikasi/update.blade.php ENDPATH**/ ?>