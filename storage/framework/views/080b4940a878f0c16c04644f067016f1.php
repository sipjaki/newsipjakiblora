...
<table>
        ...
        $start = ($data->currentPage() - 1) * $data->perPage() + 1;
            ...
            <tr>
                ...
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->nama_lengkap); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->nopjt); ?></td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e($item->sfesifikasi); ?></td>
             
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;">
                    <?php echo e(\Carbon\Carbon::parse($item->tanggal_terbit)->locale('id')->translatedFormat('d F Y')); ?>

                </td>
                <td style="font-size: 12px; text-transform: uppercase; text-align:center;">
                    <?php echo e(\Carbon\Carbon::parse($item->masa_berlaku)->locale('id')->translatedFormat('d F Y')); ?>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/penanggungjawabteknis/index.blade.php ENDPATH**/ ?>