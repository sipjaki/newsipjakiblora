...
Peraturan Gubernur Tentang Jasa Konstruksi
</h2>
</div>
...
">
  <div style="display: flex; align-items: center;">
    ...
    <div class="pdf-container">
        <iframe class="pdf-frame" src="<?php echo e(asset('storage/' . $item->peraturan)); ?>"></iframe>
    </div>
...
<script>
    document.getElementById('downloadBtn').addEventListener('click', function() {
        // URL file PDF
        const pdfUrl = '<?php echo e(asset('storage/' . $item->peraturan)); ?>';
        
        // Nama file yang diunduh berdasarkan atribut judul
        const fileName = '<?php echo e($item->judul); ?>' + '.pdf'; // Pastikan menambahkan ekstensi file yang sesuai
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/11_peraturan/09_peraturangubernur.blade.php ENDPATH**/ ?>