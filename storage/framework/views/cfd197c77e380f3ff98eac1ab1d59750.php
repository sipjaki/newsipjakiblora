...
<br>
        <div class="container-update" style="col-lg-12">
            <!-- Menampilkan pesan sukses jika ada -->
                ...
                <form action="<?php echo e(route('update.dokumentasipelatihan', $kegiatanjaskon->judul_kegiatan)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="text" class="form-control" id="judul_kegiatan" name="judul_kegiatan" value="<?php echo e(old('judul_kegiatan', $kegiatanjaskon->judul_kegiatan)); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="pengawasanlokasi_id" name="pengawasanlokasi_id" required>
                            ...
                            <?php $__currentLoopData = $datapengawasanlokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($lokasi->id); ?>" <?php echo e(old('pengawasanlokasi_id', $kegiatanjaskon->pengawasanlokasi_id) == $lokasi->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="text" class="form-control" id="alamat_kegiatan" name="alamat_kegiatan" value="<?php echo e(old('alamat_kegiatan', $kegiatanjaskon->alamat_kegiatan)); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo e(old('tanggal', $kegiatanjaskon->tanggal)); ?>" required>
                    </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/03_dokumentasipelatihan/update.blade.php ENDPATH**/ ?>