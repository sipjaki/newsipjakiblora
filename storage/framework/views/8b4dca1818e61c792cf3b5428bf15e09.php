...
<br>
        <div class="container-update" style="col-lg-12">
            <!-- Menampilkan pesan sukses jika ada -->
                ...
                <form action="<?php echo e(route('updatestore.pengawasandanketertiban', $data->judul)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="pengawasanlokasi_id" name="pengawasanlokasi_id" required>
                            <option value="" disabled <?php echo e(old('pengawasanlokasi_id', $data->pengawasanlokasi_id) == '' ? 'selected' : ''); ?>>PILIH LOKASI</option>
                            <?php $__currentLoopData = $datapengawasanlokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kota->id); ?>" <?php echo e(old('pengawasanlokasi_id', $data->pengawasanlokasi_id) == $kota->id ? 'selected' : ''); ?>>
                                    <?php echo e($kota->kota); ?>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="pengawasanbangunangedung_id" name="pengawasanbangunangedung_id" required>
                            <option value="" disabled <?php echo e(old('pengawasanbangunangedung_id', $data->pengawasanbangunangedung_id) == '' ? 'selected' : ''); ?>>JENIS BANGUNAN GEDUNG</option>
                            <?php $__currentLoopData = $datapengawasanbangunan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bangunan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($bangunan->id); ?>" <?php echo e(old('pengawasanbangunangedung_id', $data->pengawasanbangunangedung_id) == $bangunan->id ? 'selected' : ''); ?>>
                                    <?php echo e($bangunan->bangunan); ?>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="penanggungjawabteknis_id" name="penanggungjawabteknis_id" required>
                            <option value="" disabled <?php echo e(old('penanggungjawabteknis_id', $data->penanggungjawabteknis_id) == '' ? 'selected' : ''); ?>>PILIH PENANGGUNG JAWAB TEKNIS</option>
                            <?php $__currentLoopData = $datapenanggungjawabteknis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option style="text-transform: uppercase;" value="<?php echo e($item->id); ?>" <?php echo e(old('penanggungjawabteknis_id', $data->penanggungjawabteknis_id) == $item->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="pengawasanstatus_id" name="pengawasanstatus_id" required>
                            <option value="" disabled <?php echo e(old('pengawasanstatus_id', $data->pengawasanstatus_id) == '' ? 'selected' : ''); ?>>PILIH STATUS PENGAWASAN</option>
                            <?php $__currentLoopData = $datapengawasanstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option style="text-transform: uppercase;" value="<?php echo e($item->id); ?>" <?php echo e(old('pengawasanstatus_id', $data->pengawasanstatus_id) == $item->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <select class="form-control" id="pengawasantindakan_id" name="pengawasantindakan_id" required>
                            <option value="" disabled <?php echo e(old('pengawasantindakan_id', $data->pengawasantindakan_id) == '' ? 'selected' : ''); ?>>PILIH PENGAWASAN TINDAKAN</option>
                            <?php $__currentLoopData = $datapengawasantindakan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option style="text-transform: uppercase;" value="<?php echo e($item->id); ?>" <?php echo e(old('pengawasantindakan_id', $data->pengawasantindakan_id) == $item->id ? 'selected' : ''); ?>>
                                    <?php echo e($item->tindakan); ?>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" value="<?php echo e(old('judul', $data->judul)); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_laporan" name="tanggal_laporan" value="<?php echo e(old('tanggal_laporan', $data->tanggal_laporan)); ?>" required>
                    </div>
                    ...
                    <div class="form-group d-flex align-items-center mt-3">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="10" required><?php echo e(old('keterangan', $data->keterangan)); ?></textarea>
                    </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/03_datajakon/01_pengawasanketertiban/update.blade.php ENDPATH**/ ?>