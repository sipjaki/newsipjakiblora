...
<style>
 ...
 <table style="margin-top:50px;">
    ...
    <tbody>
        ...
        <tr>
            <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($loop->iteration); ?></td>
            <td style="font-size: 12px; text-transform: uppercase; text-align:left;"><?php echo e($item->nama_kecamatan); ?></td>
            
            <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e(number_format($item->laki_laki)); ?> JIWA</td>
            <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e(number_format($item->perempuan)); ?> JIWA</td>
            <td style="font-size: 12px; text-transform: uppercase; text-align:center;"><?php echo e(number_format($item->total_penduduk)); ?> JIWA</td>
        ...
        .iconhover i {
            ...
            <a href="/giskbb/<?php echo e($item->nama_kecamatan); ?>" class="iconhover" title="View">
                <button style="
                background: green; 
                border: none; 
                cursor: pointer; 
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/giskkbb/index.blade.php ENDPATH**/ ?>