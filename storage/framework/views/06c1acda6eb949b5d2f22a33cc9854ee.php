    ...
    <tbody>
        ...
        <tr>
            <td style="width: 50px; padding: 10px; vertical-align: top;">
                ...
                <img src="<?php echo e(asset('storage/' . $data->foto_kegiatanpekerja1)); ?>" alt="<?php echo e(asset('storage/' . $data->foto_kegiatanpekerja1)); ?>" class="responsive-img">
                <img src="<?php echo e(asset('storage/' . $data->foto_kegiatanpekerja2)); ?>" alt="<?php echo e(asset('storage/' . $data->foto_kegiatanpekerja2)); ?>" class="responsive-img">
...
<?php echo $__env->make('backend.00_dashboard.part.menufooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/04_skk/01_skk/showkegiatan.blade.php ENDPATH**/ ?>