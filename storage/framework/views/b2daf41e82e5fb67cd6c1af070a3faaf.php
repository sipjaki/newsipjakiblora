...
<br>
        <div class="container-update" style="col-lg-12">
            ...
            <form action="/acarapelatihanstore/<?php echo e($laporankegiatan->judul_kegiatan); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <select class="form-control" id="kegiatanjaskon_id" name="kegiatanjaskon_id" required>
                        <option value="" disabled <?php echo e(old('kegiatanjaskon_id', $laporankegiatan->kegiatanjaskon_id) == '' ? 'selected' : ''); ?>>
                            PILIH AGENDA ACARA
                        </option>
                        <?php $__currentLoopData = $datakegiatanjaskon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>" <?php echo e(old('kegiatanjaskon_id', $laporankegiatan->kegiatanjaskon_id) == $item->id ? 'selected' : ''); ?>>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input type="text" class="form-control" id="judul_kegiatan" name="judul_kegiatan" value="<?php echo e(old('judul_kegiatan', $laporankegiatan->judul_kegiatan)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input type="text" class="form-control" id="user_id" name="user_id" value="<?php echo e(old('user_id', $laporankegiatan->user->username)); ?>" required readonly>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?php echo e(old('jabatan', $laporankegiatan->jabatan)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo e(old('tanggal', $laporankegiatan->tanggal)); ?>" required>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <textarea class="form-control" id="keterangan_berita" name="keterangan_berita" rows="20" style="resize: vertical;" required><?php echo e(old('keterangan_berita', $laporankegiatan->keterangan_berita)); ?></textarea>
                </div>
                ...
                <div class="form-group d-flex align-items-center mt-3">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="preview-container">
                            <img id="gambar-preview" src="<?php echo e(asset('storage/' . $laporankegiatan->gambar)); ?>" alt="Preview" class="img-preview" style="width: 100px; height: 100px; object-fit: cover;"/>
                        </div>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/02_berita/04_acarapelatihan/updateberitaacara.blade.php ENDPATH**/ ?>