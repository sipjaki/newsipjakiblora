             ...
             <table id="datakeluar" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <img src="<?php echo e($data->foto_asosiasi); ?>" 
                                alt="Gambar Profil" 
                        ...
                        <td style="padding: 10px;">
                            <table style="width: 100%; border-collapse: collapse;">
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #FFCB0F; width: 20px;">:</td>
                                    <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                        <?php echo e(ucwords(strtolower($data->kota))); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #FFCB0F; width: 20px;">:</td>
                                    <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                        <?php echo e(ucwords(strtolower($data->kontak))); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #FFCB0F; width: 20px;">:</td>
                                    <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                        <?php echo e(ucwords(strtolower($data->website))); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #FFCB0F; width: 20px;">:</td>
                                    <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                        <?php echo e(ucwords(strtolower($data->kepala_asosiasi))); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #FFCB0F; width: 20px;">:</td>
                                    <td style="background-color: rgba(192, 192, 192, 0.3); font-size: 14px; text-transform: capitalize; text-align: left; font-weight: 700; color: black;">
                                        <?php echo e(ucwords(strtolower($data->jumlah_anggota))); ?>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/03_datajakon/01_asosiasishow.blade.php ENDPATH**/ ?>