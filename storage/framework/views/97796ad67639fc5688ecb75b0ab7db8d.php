...
<style>
             ...
             <table>
                ...
                $start = ($datastatusadmin->currentPage() - 1) * $datastatusadmin->perPage() + 1;
                    ...
                    <?php $__currentLoopData = $datastatusadmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                    <tr>
                        <td style="font-size: 12px;"><?php echo e($loop->iteration + $start - 1); ?></td>
                        <td style="font-size: 12px; text-align:center;"><?php echo e($item->status); ?></td>
                        <td>
                    ...
                    .iconhover i {
                        ...
                        <div class="button-container">
                                ...
                                <a href="#" class="iconhover" title="Delete" data-toggle="modal" data-target="#deleteModal" onclick="setDeleteAction('<?php echo e(route('delete.deletekategoriadmin', $item->status)); ?>')">
        ...
        <div class="pagination-container" style="margin-top: 75px; margin-bottom:75px; display: flex; flex-direction: column; align-items: center;">
                <div class="pagination-info mb-2" style="margin-bottom: 10px; color:orange; font-weight: 500;">
                    Data Ke <?php echo e($datastatusadmin->firstItem()); ?> Sampai <?php echo e($datastatusadmin->lastItem()); ?> Dari <?php echo e($datastatusadmin->total()); ?> Jumlah <?php echo e($title); ?>

                </div>
                    <ul class="pagination" style="display: flex; padding-left: 0; list-style: none;">
                        <li class="page-item <?php echo e($datastatusadmin->onFirstPage() ? 'disabled' : ''); ?>" style="margin-right: 5px;">
                            <a class="page-link" href="<?php echo e($datastatusadmin->previousPageUrl()); ?>" style="position: relative; display: block; padding: 0.5rem 0.75rem; margin-left: -1px; line-height: 1.25; color: white; background-color: #fff; border: 1px solid #dee2e6; font-size:12px; border-radius: 20px 0px 0px 20px;"><i class="fas fa-arrow-left" style="margin-right:10px;"></i>Previous</a>
                        </li>

                        <?php $__currentLoopData = $datastatusadmin->getUrlRange($datastatusadmin->currentPage() - 0, $datastatusadmin->currentPage() + 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="page-item <?php echo e($page == $datastatusadmin->currentPage() ? 'active' : ''); ?>" style="margin-right: 5px;">
                        ...
                        <li class="page-item <?php echo e($datastatusadmin->hasMorePages() ? '' : 'disabled'); ?>" style="margin-right: 5px;">
                            <a class="page-link" href="<?php echo e($datastatusadmin->nextPageUrl()); ?>" style="position: relative; display: block; padding: 0.5rem 0.75rem; margin-left: -1px; line-height: 1.25; color: white; background-color: #fff; border: 1px solid #dee2e6; font-size:12px; border-radius: 0px 20px 20px 0px;">Next <i class="fas fa-arrow-right" style="margin-left:10px;"></i></a>
                        </li>
                    </ul>
    ...
    <?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/backend/15_administrator/kategoriadmin/index.blade.php ENDPATH**/ ?>