...
<form id="kecamatan-form" method="GET" action="<?php echo e(url('/tenagakerja/keterampilan')); ?>">
    <div class="custom-select-wrapper">
        <select name="judul" id="kecamatan-dropdown" onchange="submitForm()">
            <option value="">PILIH KETERAMPILAN</option>
            <?php $__currentLoopData = $data_keterampilan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keterampilan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($keterampilan); ?>"><?php echo e($keterampilan); ?></option>
    ...
    <style>
     ...
     <table>
        ...
        $start = ($data->currentPage() - 1) * $data->perPage() + 1;
            ...
            <tr>
                <td style="font-size: 12px; text-transform:uppercase; text-align:left;"><?php echo e($loop->iteration + $start - 1); ?></td>
                <td style="font-size: 12px; text-transform:uppercase; text-align:left;"><?php echo e($item->keterampilan); ?></td>
                <td style="font-size: 12px; text-transform:uppercase; text-align:left;"><?php echo e($item->desa); ?></td>
                <td style="font-size: 12px; text-transform:uppercase; text-align:left;"><?php echo e($item->kecamatan); ?></td>
                <td style="font-size: 12px; text-transform:uppercase; text-align:left;"><?php echo e($item->nama); ?></td>
...
<?php echo $__env->make('frontend.00_atas.footer2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01. SIPJAKI KABUPATEN BANDUNG BARAT\APLIKASI\sipjakikbbpermen\resources\views/frontend/04_tenagakerja/01_skasktalldataketerampilanshow.blade.php ENDPATH**/ ?>