    ...
    <ul class="navbar-nav ml-auto">
	  ...
	  <li class="nav-item dropdown">
        <a class="nav-link" href="#" data-toggle="dropdown">Services <i class="fas fa-chevron-down"></i></a>
		  <ul class="dropdown-menu small-menu">
		     <a href="urban-infrastructure.php">Urban Infrastructure</a>
		     <a href="road-infrastructure.php">Road Infrastructure</a>
		     <a href="industrial-infrastructure.php">Industrial Infrastructure</a>
		     <a href="construction-engineering.php">Construction engineering</a>
		     <a href="structure-engineering.php">Structure Engineering</a>
		     <a href="water-sewage-engineering.php">Water and sewage engineering</a>
